...
; location of global variables
  ...
  %define global_crates 114
  %define global_player 124
  %define global_floorBody 125
...
__if_1521_start:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_1523
  mov R2, [BP-1]
  iadd R2, 3
  mov R1, [R2]
  and R0, R1
__LogicalAnd_ShortCircuit_1523:
  jf R0, __if_1521_end
  mov R0, [BP-2]
  mov R1, [BP-1]
  iadd R1, 1
...
__if_1625_start:
  ...
  ine R0, -1
  bnot R0
  jt R0, __LogicalOr_ShortCircuit_1628
  mov R2, [BP-2]
  iadd R2, 3
  mov R1, [R2]
  bnot R1
  or R0, R1
__LogicalOr_ShortCircuit_1628:
  jf R0, __if_1625_end
  mov R0, 0
  jmp __function_expand_malloc_block_return
__if_1625_end:
...
__if_1705_end:
  ...
  mov [BP-1], R0
__while_1714_start:
__while_1714_continue:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __while_1714_end
__if_1717_start:
  mov R1, [BP-1]
  iadd R1, 3
  mov R0, [R1]
  jf R0, __LogicalAnd_ShortCircuit_1720
  mov R2, [BP-1]
  iadd R2, 2
  mov R1, [R2]
  mov R2, [BP+2]
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_1720:
  jf R0, __if_1717_end
  jmp __while_1714_end
__if_1717_end:
  mov R1, [BP-1]
  iadd R1, 1
  mov R0, [R1]
  mov [BP-1], R0
  jmp __while_1714_start
__while_1714_end:
__if_1730_start:
  mov R0, [BP-1]
  ine R0, -1
...
__if_3007_start:
  mov R0, [BP+2]
  feq R0, 0.000000
  jf R0, __LogicalAnd_ShortCircuit_3012
  mov R1, [BP+3]
  feq R1, 0.000000
  and R0, R1
__LogicalAnd_ShortCircuit_3012:
  jf R0, __if_3007_end
  mov R0, 0.000000
...
__function_b2IsNormalizedRot:
  ...
  mov R0, [BP-1]
  fgt R0, 0.999400
  jf R0, __LogicalAnd_ShortCircuit_3271
  mov R1, [BP-1]
  flt R1, 1.000600
  and R0, R1
__LogicalAnd_ShortCircuit_3271:
...
__function_b2AABB_Contains:
  ...
  mov [BP-1], R0
  mov R0, [BP-1]
  jf R0, __LogicalAnd_ShortCircuit_3492
  mov R2, [BP+2]
  mov R1, [R2]
  mov R3, [BP+3]
  mov R2, [R3]
  fle R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_3492:
  mov [BP-1], R0
  mov R0, [BP-1]
  jf R0, __LogicalAnd_ShortCircuit_3503
  mov R2, [BP+2]
  iadd R2, 1
  mov R1, [R2]
  mov R3, [BP+3]
  ...
  fle R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_3503:
  mov [BP-1], R0
  mov R0, [BP-1]
  jf R0, __LogicalAnd_ShortCircuit_3514
  mov R2, [BP+3]
  iadd R2, 2
  mov R1, [R2]
  mov R3, [BP+2]
  ...
  fle R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_3514:
  mov [BP-1], R0
  mov R0, [BP-1]
  jf R0, __LogicalAnd_ShortCircuit_3525
  mov R2, [BP+3]
  iadd R2, 2
  iadd R2, 1
  mov R1, [R2]
  ...
  fle R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_3525:
  mov [BP-1], R0
  mov R0, [BP-1]
...
__function_b2IsValidVec2:
  ...
  mov R1, R0
  jf R1, __LogicalAnd_ShortCircuit_3782
  mov R4, [BP+2]
  iadd R4, 1
  mov R3, [R4]
  mov [SP], R3
  ...
  mov R2, R0
  and R1, R2
__LogicalAnd_ShortCircuit_3782:
  mov R0, R1
...
__if_62531_start:
  ...
  ieq R1, 0
  mov R0, R1
  jf R0, __if_62531_end
  mov R0, 0.000000
  jmp __function_vb2_GetMass_return
__if_62531_end:
  mov R1, global_vb2_world
  mov [SP], R1
  lea R1, [BP-3]
  mov [SP+1], R1
  call __function_b2Body_GetMass
__function_vb2_GetMass_return:
  iadd SP, 2
  pop R2
  pop R1
  mov SP, BP
...
__function_vb2_HitNX:
  push BP
  mov BP, SP
  mov R0, [global_vb2_lastHit]
__function_vb2_HitNX_return:
  mov SP, BP
  pop BP
  ret

__function_vb2_HitNY:
  push BP
  mov BP, SP
  mov R0, [105]
__function_vb2_HitNY_return:
  mov SP, BP
  pop BP
  ret
...
__function_vb2_BodyAt:
  ...
  isub SP, 6
  mov R0, [BP+2]
  mov [global_vb2_pickX], R0
  mov R0, [BP+3]
  mov [global_vb2_pickY], R0
  mov R0, -1
  mov [global_vb2_pickShape], R0
  mov R0, [BP+2]
  mov [BP-4], R0
  ...
  mov R1, -1
  mov [SP+2], R1
  mov R1, __function_vb2_PointPickCallback
  mov [SP+3], R1
  mov R1, -1
  mov [SP+4], R1
  lea R1, [BP-6]
  mov [SP+5], R1
  call __function_b2World_OverlapAABB
  mov R1, [global_vb2_pickShape]
  mov [SP], R1
  call __function_vb2_BodyOfShape
__function_vb2_BodyAt_return:
  iadd SP, 6
  pop R1
  mov SP, BP
  pop BP
...
__if_63345_start:
  ...
  mov R1, [BP+2]
  ieq R0, R1
  jf R0, __if_63345_end
  mov R0, 1
  jmp __function_IsCrate_return
__if_63345_end:
__for_63336_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_63336_start
__for_63336_end:
  mov R0, 0
__function_IsCrate_return:
  pop R1
  mov SP, BP
  pop BP
  ret
...
__function_main:
  ...
  mov R1, R0
  mov [global_player], R1
  mov R0, R1
  mov R1, [global_player]
  mov [SP], R1
  mov R1, 0.900000
  mov [SP+1], R1
...
__for_63403_start:
  ...
  mov [R2], R1
  mov R0, R1
__for_63403_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_63403_start
__for_63403_end:
  mov R0, 0.600000
  mov [BP-3], R0
  mov R0, 0
...
__while_63449_start:
__while_63449_continue:
  mov R0, 1
  jf R0, __while_63449_end
  mov R1, [global_player]
  mov [SP], R1
...
__if_63530_start:
  ...
  mov R1, R0
  ieq R1, 1
  jf R1, __LogicalAnd_ShortCircuit_63535
  mov R2, [BP-8]
  and R1, R2
__LogicalAnd_ShortCircuit_63535:
  mov R0, R1
  jf R0, __if_63530_end
  mov R1, [global_player]
  mov [SP], R1
  mov R1, 0.000000
  mov [SP+1], R1
...
__if_63610_start:
  ...
  mov [BP-16], R1
  mov R0, R1
  call __function_vb2_HitNX
  mov R1, R0
  mov [BP-17], R1
  mov R0, R1
  call __function_vb2_HitNY
  mov R1, R0
  mov [BP-18], R1
  mov R0, R1
__if_63610_end:
...
__if_63629_start:
  mov R1, [BP-14]
  ine R1, -1
  jf R1, __LogicalAnd_ShortCircuit_63636
  mov R3, [BP-14]
  mov [SP], R3
  call __function_IsCrate
  mov R2, R0
  and R1, R2
__LogicalAnd_ShortCircuit_63636:
  mov R0, R1
  jf R0, __if_63629_end
  mov R1, [BP-14]
  mov [SP], R1
...
__if_63691_start:
  mov R0, [BP-8]
  jf R0, __if_63691_end
  mov R1, 470
  mov [SP], R1
  mov R1, 22
  mov [SP+1], R1
  mov R1, __literal_string_63696
  mov [SP+2], R1
  call __function_print_at
__if_63691_end:
__if_63697_start:
  mov R0, [BP-14]
  ine R0, -1
  jf R0, __if_63697_end
__if_63703_start:
  mov R1, [BP-14]
  mov [SP], R1
  call __function_IsCrate
  jf R0, __if_63703_else
  mov R1, 260
  mov [SP], R1
  mov R1, 40
  mov [SP+1], R1
  mov R1, __literal_string_63709
  mov [SP+2], R1
  call __function_print_at
  jmp __if_63703_end
__if_63703_else:
__if_63710_start:
  mov R0, [BP-14]
  mov R1, [global_floorBody]
  ieq R0, R1
  jf R0, __if_63710_else
  mov R1, 260
  mov [SP], R1
  mov R1, 40
  mov [SP+1], R1
  mov R1, __literal_string_63717
  mov [SP+2], R1
  call __function_print_at
  jmp __if_63710_end
__if_63710_else:
...
__for_63724_start:
  ...
  mov R1, [BP-28]
  mov [SP+1], R1
  mov R1, __literal_string_63743
  mov [SP+2], R1
  call __function_print_at
__for_63724_continue:
  mov R0, [BP-23]
  fadd R0, 0.500000
  mov [BP-23], R0
  jmp __for_63724_start
__for_63724_end:
  mov R0, -7.000000
  mov [BP-24], R0
__for_63746_start:
  ...
  mov R1, [BP-28]
  mov [SP+1], R1
  mov R1, __literal_string_63772
  mov [SP+2], R1
  call __function_print_at
__for_63746_continue:
  mov R0, [BP-24]
  fadd R0, 0.500000
  mov [BP-24], R0
  jmp __for_63746_start
__for_63746_end:
__if_63773_start:
  mov R0, [BP-13]
  jf R0, __if_63773_end
  mov R0, 0.000000
  mov [BP-25], R0
__for_63778_start:
  mov R0, [BP-25]
  fle R0, 1.000000
  jf R0, __for_63778_end
  mov R0, [BP-11]
  mov R1, [BP-15]
  mov R2, [BP-11]
  fsub R1, R2
  ...
  mov R1, [BP-28]
  mov [SP+1], R1
  mov R1, __literal_string_63820
  mov [SP+2], R1
  call __function_print_at
__for_63778_continue:
  mov R0, [BP-25]
  fadd R0, 0.040000
  mov [BP-25], R0
  jmp __for_63778_start
__for_63778_end:
__if_63821_start:
  mov R0, [BP-14]
  ine R0, -1
  jf R0, __if_63821_end
  mov R2, [BP-16]
  mov [SP], R2
  call __function_vb2_ScreenY
  mov R1, R0
...
__if_63889_start:
  ...
  call __function_print_at
__if_63889_end:
__for_63880_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_63880_start
__for_63880_end:
  mov R2, [BP-6]
  mov [SP], R2
  call __function_vb2_ScreenY
  ...
  mov R1, [BP-28]
  mov [SP+1], R1
  mov R1, __literal_string_63919
  mov [SP+2], R1
  call __function_print_at
  call __function_end_frame
  jmp __while_63449_start
__while_63449_end:
...
__literal_string_1146:
  string "-2147483648"
__literal_string_63678:
  string "LESSON 5: RAY CASTS"
__literal_string_63682:
  string "DPAD ROLL/AIM   A JUMP   B LASER"
__literal_string_63686:
  string "SCORE"
__literal_string_63696:
  string "GROUNDED"
__literal_string_63709:
  string "-> CRATE"
__literal_string_63717:
  string "-> FLOOR"
__literal_string_63721:
  string "-> WALL"
__literal_string_63743:
  string "="
__literal_string_63766:
  string "|"
__literal_string_63772:
  string "|"
__literal_string_63820:
  string "."
__literal_string_63836:
  string "X"
__literal_string_63854:
  string "*"
__literal_string_63869:
  string "()"
__literal_string_63879:
  string "+"
__literal_string_63909:
  string "[]"
__literal_string_63919:
  string "O"
