...
__function_b2World_GetSensorBeginEventCount:
  push BP
  mov BP, SP
  push R1
  mov R1, [BP+2]
  ...
  iadd R1, 1
  mov R0, [R1]
__function_b2World_GetSensorBeginEventCount_return:
  pop R1
  mov SP, BP
  pop BP
  ret

__function_b2World_GetSensorBeginEvents:
  push BP
  mov BP, SP
  push R1
  mov R1, [BP+2]
  iadd R1, 76
  mov R0, [R1]
__function_b2World_GetSensorBeginEvents_return:
  pop R1
  mov SP, BP
  pop BP
  ret
...
__function_b2Body_SetGravityScale:
  push BP
  mov BP, SP
  isub SP, 3
  mov R1, [BP+2]
  ...
  mov [R2], R1
  mov R0, R1
__function_b2Body_SetGravityScale_return:
  mov SP, BP
  pop BP
  ret
...
__for_63374_start:
  ...
  mov [R2], R1
  mov R0, R1
__for_63374_continue:
  mov R0, [BP-6]
  mov R1, R0
  iadd R1, 1
  mov [BP-6], R1
  jmp __for_63374_start
__for_63374_end:
  lea R1, [BP-28]
  mov [SP], R1
  call __function_b2DefaultBodyDef
...
__while_63470_start:
__while_63470_continue:
  mov R0, 1
  jf R0, __while_63470_end
  mov R1, [BP-1]
  mov [SP], R1
...
__if_63533_start:
  ...
  mov R1, R0
  ieq R1, 1
  jf R1, __LogicalAnd_ShortCircuit_63538
  mov R2, [BP-92]
  and R1, R2
__LogicalAnd_ShortCircuit_63538:
  mov R0, R1
  jf R0, __if_63533_end
  mov R1, [BP-1]
  mov [SP], R1
  mov R1, 0.000000
  mov [SP+1], R1
...
__if_63554_start:
  ...
  mov R1, 0.300000
  mov [SP+2], R1
  call __function_b2Body_SetGravityScale
  jmp __if_63554_end
__if_63554_else:
  mov R1, global_vb2_world
  mov [SP], R1
...
__if_63545_end:
  ...
  mov R1, global_vb2_world
  mov [SP], R1
  call __function_b2World_GetSensorBeginEventCount
  mov [BP-93], R0
  mov R1, global_vb2_world
  mov [SP], R1
  call __function_b2World_GetSensorBeginEvents
  mov [BP-94], R0
  mov R0, 0
  mov [BP-95], R0
__for_63581_start:
...
__if_63611_start:
  ...
  mov [BP-88], R0
__if_63611_end:
__for_63581_continue:
  mov R0, [BP-95]
  mov R1, R0
  iadd R1, 1
  mov [BP-95], R1
  jmp __for_63581_start
__for_63581_end:
  mov R1, -16777216
  mov [SP], R1
...
__if_63646_start:
  mov R0, [BP-86]
  jf R0, __if_63646_end
  mov R1, 470
  mov [SP], R1
  mov R1, 22
  mov [SP+1], R1
  mov R1, __literal_string_63651
  mov [SP+2], R1
  call __function_print_at
__if_63646_end:
__if_63652_start:
...
__for_63668_start:
  ...
  mov R1, [BP-105]
  mov [SP+1], R1
  mov R1, __literal_string_63687
  mov [SP+2], R1
  call __function_print_at
__for_63668_continue:
  mov R0, [BP-96]
  fadd R0, 0.500000
  mov [BP-96], R0
  jmp __for_63668_start
__for_63668_end:
  mov R0, -7.000000
  mov [BP-97], R0
__for_63690_start:
  ...
  mov R1, [BP-105]
  mov [SP+1], R1
  mov R1, __literal_string_63716
  mov [SP+2], R1
  call __function_print_at
__for_63690_continue:
  mov R0, [BP-97]
  fadd R0, 0.500000
  mov [BP-97], R0
  jmp __for_63690_start
__for_63690_end:
  mov R0, -1.500000
  mov [BP-98], R0
__for_63719_start:
  ...
  mov R1, [BP-105]
  mov [SP+1], R1
  mov R1, __literal_string_63792
  mov [SP+2], R1
  call __function_print_at
__for_63719_continue:
  mov R0, [BP-98]
  fadd R0, 0.500000
  mov [BP-98], R0
  jmp __for_63719_start
__for_63719_end:
  mov R0, 0
  mov [BP-6], R0
__for_63793_start:
  ...
  mov R1, [BP-105]
  mov [SP+1], R1
  mov R1, __literal_string_63817
  mov [SP+2], R1
  call __function_print_at
__for_63793_continue:
  mov R0, [BP-6]
  mov R1, R0
  iadd R1, 1
  mov [BP-6], R1
  jmp __for_63793_start
__for_63793_end:
  mov R2, [BP-90]
  mov [SP], R2
  call __function_vb2_ScreenY
  ...
  mov R1, [BP-105]
  mov [SP+1], R1
  mov R1, __literal_string_63827
  mov [SP+2], R1
  call __function_print_at
  call __function_end_frame
  jmp __while_63470_start
__while_63470_end:
...
__literal_string_1146:
  string "-2147483648"
__literal_string_63633:
  string "LESSON 7: BEYOND THE FACADE"
__literal_string_63637:
  string "DPAD ROLL   A JUMP   B MOON MODE"
__literal_string_63641:
  string "GOALS"
__literal_string_63651:
  string "MOON 0.3G"
__literal_string_63665:
  string "GOAL!"
__literal_string_63687:
  string "="
__literal_string_63710:
  string "|"
__literal_string_63716:
  string "|"
__literal_string_63747:
  string "."
__literal_string_63762:
  string "."
__literal_string_63777:
  string "."
__literal_string_63792:
  string "."
__literal_string_63817:
  string "[]"
__literal_string_63827:
  string "O"
