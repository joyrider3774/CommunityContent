...
__function_vb2_JointExists:
  ...
  lea R1, [BP-3]
  mov [SP+1], R1
  call __function_vb2_ResolveJoint
__function_vb2_JointExists_return:
  iadd SP, 2
  pop R1
  mov SP, BP
  pop BP
...
__if_63033_start:
  ...
  ieq R1, 0
  mov R0, R1
  jf R0, __if_63033_end
  mov R0, -1
  jmp __function_vb2_Pin_return
__if_63033_end:
__if_63043_start:
  mov R2, [BP+3]
  mov [SP], R2
...
__if_63140_start:
  ...
  ieq R1, 0
  mov R0, R1
  jf R0, __if_63140_end
  mov R0, -1
  jmp __function_vb2_Rope_return
__if_63140_end:
__if_63150_start:
  mov R2, [BP+3]
  mov [SP], R2
...
__if_63258_start:
  ...
  ieq R1, 0
  mov R0, R1
  jf R0, __if_63258_end
  jmp __function_vb2_Motor_return
__if_63258_end:
__if_63266_start:
  mov R2, global_vb2_world
  mov [SP], R2
  lea R2, [BP-3]
  mov [SP+1], R2
  call __function_b2Joint_GetType
  mov R1, R0
  ine R1, 4
  mov R0, R1
  jf R0, __if_63266_end
  jmp __function_vb2_Motor_return
__if_63266_end:
  mov R1, global_vb2_world
  mov [SP], R1
  ...
  mov R1, 1
  mov [SP+2], R1
  call __function_b2RevoluteJoint_EnableMotor
  mov R1, global_vb2_world
  mov [SP], R1
  lea R1, [BP-3]
  mov [SP+1], R1
  mov R1, [BP+3]
  mov [SP+2], R1
  call __function_b2RevoluteJoint_SetMotorSpeed
  mov R1, global_vb2_world
  mov [SP], R1
  lea R1, [BP-3]
  mov [SP+1], R1
  mov R1, [BP+4]
  mov [SP+2], R1
  call __function_b2RevoluteJoint_SetMaxMotorTorque
__function_vb2_Motor_return:
  mov SP, BP
  pop BP
  ret

__function_vb2_DestroyJoint:
  push BP
  mov BP, SP
  isub SP, 5
__if_63297_start:
  ...
  ieq R1, 0
  mov R0, R1
  jf R0, __if_63297_end
  jmp __function_vb2_DestroyJoint_return
__if_63297_end:
  mov R1, global_vb2_world
  mov [SP], R1
  lea R1, [BP-3]
  mov [SP+1], R1
  call __function_b2DestroyJoint
__function_vb2_DestroyJoint_return:
  mov SP, BP
  pop BP
  ret
...
__while_63450_start:
__while_63450_continue:
  mov R0, 1
  jf R0, __while_63450_end
__if_63453_start:
  call __function_gamepad_right
  mov R1, R0
  igt R1, 0
  mov R0, R1
  jf R0, __if_63453_else
  mov R1, [BP-4]
  mov [SP], R1
  mov R1, -14.000000
  mov [SP+1], R1
...
__if_63503_start:
  ...
  mov R1, R0
  ieq R1, 1
  jf R1, __LogicalAnd_ShortCircuit_63509
  mov R3, [BP-8]
  mov [SP], R3
  call __function_vb2_JointExists
  mov R2, R0
  and R1, R2
__LogicalAnd_ShortCircuit_63509:
  mov R0, R1
  jf R0, __if_63503_end
  mov R1, [BP-8]
  mov [SP], R1
  call __function_vb2_DestroyJoint
__if_63503_end:
...
__for_63527_start:
  ...
  mov R1, [BP-21]
  mov [SP+1], R1
  mov R1, __literal_string_63546
  mov [SP+2], R1
  call __function_print_at
__for_63527_continue:
  mov R0, [BP-14]
  fadd R0, 0.500000
  mov [BP-14], R0
  jmp __for_63527_start
__for_63527_end:
  mov R0, -7.000000
  mov [BP-15], R0
__for_63549_start:
  ...
  mov R1, [BP-21]
  mov [SP+1], R1
  mov R1, __literal_string_63575
  mov [SP+2], R1
  call __function_print_at
__for_63549_continue:
  mov R0, [BP-15]
  fadd R0, 0.500000
  mov [BP-15], R0
  jmp __for_63549_start
__for_63549_end:
  mov R0, 0.000000
  mov [BP-16], R0
__for_63578_start:
...
__if_63644_start:
  ...
  mov [SP], R1
  call __function_vb2_JointExists
  jf R0, __if_63644_end
  mov R0, 0.000000
  mov [BP-16], R0
__for_63648_start:
  mov R0, [BP-16]
  fle R0, 1.000000
  jf R0, __for_63648_end
  mov R0, [BP-17]
  fsub R0, 10.000000
  mov R1, [BP-16]
  fmul R0, R1
  ...
  mov R1, [BP-21]
  mov [SP+1], R1
  mov R1, __literal_string_63690
  mov [SP+2], R1
  call __function_print_at
__for_63648_continue:
  mov R0, [BP-16]
  fadd R0, 0.070000
  mov [BP-16], R0
  jmp __for_63648_start
__for_63648_end:
__if_63644_end:
  mov R2, [BP-18]
  mov [SP], R2
...
__for_63737_start:
  ...
  mov R1, [BP-21]
  mov [SP+1], R1
  mov R1, __literal_string_63761
  mov [SP+2], R1
  call __function_print_at
__for_63737_continue:
  mov R0, [BP-13]
  mov R1, R0
  iadd R1, 1
  mov [BP-13], R1
  jmp __for_63737_start
__for_63737_end:
  call __function_end_frame
  jmp __while_63450_start
__while_63450_end:
...
__literal_string_1146:
  string "-2147483648"
__literal_string_63520:
  string "LESSON 6: JOINTS"
__literal_string_63524:
  string "DPAD DRIVE   A BRAKE   B CUT ROPE"
__literal_string_63546:
  string "="
__literal_string_63569:
  string "|"
__literal_string_63575:
  string "|"
__literal_string_63625:
  string "/"
__literal_string_63643:
  string "#"
__literal_string_63690:
  string "."
__literal_string_63700:
  string "@"
__literal_string_63712:
  string "[==]"
__literal_string_63724:
  string "o"
__literal_string_63736:
  string "o"
__literal_string_63761:
  string "[]"
