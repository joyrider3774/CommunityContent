...
__while_63410_start:
__while_63410_continue:
  mov R0, 1
  jf R0, __while_63410_end
__if_63413_start:
...
__for_63515_start:
  ...
  mov R1, [BP-13]
  mov [SP+1], R1
  mov R1, __literal_string_63534
  mov [SP+2], R1
  call __function_print_at
__for_63515_continue:
  mov R0, [BP-10]
  fadd R0, 0.500000
  mov [BP-10], R0
  jmp __for_63515_start
__for_63515_end:
  mov R0, -7.000000
  mov [BP-11], R0
__for_63537_start:
  ...
  mov R1, [BP-13]
  mov [SP+1], R1
  mov R1, __literal_string_63563
  mov [SP+2], R1
  call __function_print_at
__for_63537_continue:
  mov R0, [BP-11]
  fadd R0, 0.500000
  mov [BP-11], R0
  jmp __for_63537_start
__for_63537_end:
  mov R0, 0
  mov [BP-12], R0
__for_63566_start:
  ...
  mov R1, [BP-13]
  mov [SP+1], R1
  mov R1, __literal_string_63590
  mov [SP+2], R1
  call __function_print_at
__for_63566_continue:
  mov R0, [BP-12]
  mov R1, R0
  iadd R1, 1
  mov [BP-12], R1
  jmp __for_63566_start
__for_63566_end:
  mov R3, [BP-1]
  mov [SP], R3
  call __function_vb2_GetY
  ...
  mov R1, [BP-13]
  mov [SP+1], R1
  mov R1, __literal_string_63602
  mov [SP+2], R1
  call __function_print_at
  call __function_end_frame
  jmp __while_63410_start
__while_63410_end:
...
__literal_string_1146:
  string "-2147483648"
__literal_string_63488:
  string "LESSON 3: MAKING THINGS MOVE"
__literal_string_63492:
  string "DPAD ROLL   A JUMP   B JETPACK   X DASH"
__literal_string_63496:
  string "VX"
__literal_string_63506:
  string "VY"
__literal_string_63534:
  string "="
__literal_string_63557:
  string "|"
__literal_string_63563:
  string "|"
__literal_string_63590:
  string "[]"
__literal_string_63602:
  string "O"
