...
; location of global variables
  ...
  %define global_BlockHW 122
  %define global_BlockHH 130
  %define global_BlockRegion 138
  %define global_BlockCount 146
  %define global_Player 147
  %define global_Pig 148
  %define global_PoofX 149
  %define global_PoofY 150
  %define global_PoofFrames 151
  %define global_Score 152
...
__for_63752_start:
  ...
  mov [SP+1], R1
  call __function_draw_region_at
__for_63752_continue:
  mov R0, [BP-2]
  iadd R0, 40
  mov [BP-2], R0
  jmp __for_63752_start
__for_63752_end:
...
__while_63797_start:
__while_63797_continue:
  mov R0, 1
  jf R0, __while_63797_end
__if_63800_start:
  call __function_gamepad_button_start
  mov R1, R0
  ieq R1, 1
  mov R0, R1
  jf R0, __if_63800_end
...
__if_63864_start:
  ...
  mov R1, R0
  ieq R1, 1
  jf R1, __LogicalAnd_ShortCircuit_63869
  mov R2, [BP-4]
  ine R2, -1
  and R1, R2
__LogicalAnd_ShortCircuit_63869:
  mov R0, R1
...
__for_63908_start:
  ...
  mov R1, [global_Pig]
  ieq R0, R1
  jt R0, __LogicalOr_ShortCircuit_63933
  mov R1, [BP-11]
  mov R2, [global_Pig]
  ieq R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_63933:
  mov [BP-12], R0
  mov R0, [BP-10]
  mov R1, [global_Player]
  ieq R0, R1
  jt R0, __LogicalOr_ShortCircuit_63943
  mov R1, [BP-11]
  mov R2, [global_Player]
  ieq R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_63943:
  mov [BP-13], R0
__if_63946_start:
  mov R0, [BP-12]
  jf R0, __LogicalAnd_ShortCircuit_63948
  mov R1, [BP-13]
  and R0, R1
__LogicalAnd_ShortCircuit_63948:
  jf R0, __LogicalAnd_ShortCircuit_63951
  mov R1, [BP-8]
  and R0, R1
__LogicalAnd_ShortCircuit_63951:
  jf R0, __if_63946_end
  mov R2, [global_Pig]
  mov [SP], R2
  call __function_vb2_GetX
  mov R1, R0
  ...
  mov [global_Score], R0
__if_63946_end:
__for_63908_continue:
  mov R0, [BP-9]
  mov R1, R0
  iadd R1, 1
  mov [BP-9], R1
  jmp __for_63908_start
__for_63908_end:
__if_63880_end:
...
__for_63974_continue:
  mov R0, [BP-5]
  mov R1, R0
  iadd R1, 1
  mov [BP-5], R1
  jmp __for_63974_start
__for_63974_end:
  mov R1, [global_Pig]
  mov [SP], R1
  mov R1, 1
...
__if_64006_end:
  ...
  mov R1, 340
  mov [SP+1], R1
  mov R1, __literal_string_64050
  mov [SP+2], R1
  call __function_print_at
  call __function_end_frame
  jmp __while_63797_start
__while_63797_end:
...
__literal_string_1146:
  string "-2147483648"
__literal_string_64038:
  string "LESSON 8: SPRITES"
__literal_string_64042:
  string "SCORE"
__literal_string_64050:
  string "DPAD ROLL   A JUMP   START RESET"
