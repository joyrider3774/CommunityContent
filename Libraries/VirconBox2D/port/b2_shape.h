...
*  cache, filter, material, events, world links) is deferred. Upstream's        *
*  anonymous union of shape variants (unsupported form) became separate fields.  *
*  switch -> if/else. chainSegment deferred.                                     *
