                           ...
                           float length, bool collideConnected )
{
    ...
    b2DistanceJoint* dj = &sim->u.distanceJoint;
                           ...
                           bool collideConnected )
{
    ...
    b2RevoluteJoint* rj = &sim->u.revoluteJoint;
                       ...
                       bool collideConnected )
{
    ...
    b2WeldJoint* wj = &sim->u.weldJoint;
    wj->linearHertz = 0.0;
                            ...
                            bool collideConnected )
{
    ...
    b2PrismaticJoint* pj = &sim->u.prismaticJoint;
                        ...
                        bool collideConnected )
{
    ...
    b2WheelJoint* wj = &sim->u.wheelJoint;
    wj->perpImpulse = 0.0;
    wj->motorImpulse = 0.0;
                        ...
                        bool collideConnected )
{
    ...
    b2MotorJoint* mj = &sim->u.motorJoint;
...
void b2CreateDistanceJointDef( b2World* world, b2DistanceJointDef* def, b2JointId* out )
{
    ...
    b2DistanceJoint* dj = &b2GetJointSimById( world, jid )->u.distanceJoint;
    dj->hertz = def->hertz;
...
void b2CreateRevoluteJointDef( b2World* world, b2RevoluteJointDef* def, b2JointId* out )
{
    ...
    b2RevoluteJoint* rj = &b2GetJointSimById( world, jid )->u.revoluteJoint;
...
void b2CreateWeldJointDef( b2World* world, b2WeldJointDef* def, b2JointId* out )
{
    ...
    int jid = b2CreateWeldJoint( world, idA, idB, &def->localFrameA, &def->localFrameB,
                                 def->collideConnected );
    b2WeldJoint* wj = &b2GetJointSimById( world, jid )->u.weldJoint;
...
void b2CreatePrismaticJointDef( b2World* world, b2PrismaticJointDef* def, b2JointId* out )
{
    ...
    int jid = b2CreatePrismaticJoint( world, idA, idB, &def->localFrameA, &def->localFrameB,
                                      def->collideConnected );
    b2PrismaticJoint* pj = &b2GetJointSimById( world, jid )->u.prismaticJoint;
...
void b2CreateWheelJointDef( b2World* world, b2WheelJointDef* def, b2JointId* out )
{
    ...
    int jid = b2CreateWheelJoint( world, idA, idB, &def->localFrameA, &def->localFrameB,
                                  def->collideConnected );
    b2WheelJoint* wj = &b2GetJointSimById( world, jid )->u.wheelJoint;
...
void b2CreateMotorJointDef( b2World* world, b2MotorJointDef* def, b2JointId* out )
{
    ...
    int jid = b2CreateMotorJoint( world, idA, idB, &def->localFrameA, &def->localFrameB,
                                  def->collideConnected );
    b2MotorJoint* mj = &b2GetJointSimById( world, jid )->u.motorJoint;
...
//   b2World_Step (b2PrepareJoints re-reads the fields). CAUTION: payloads are now a
//   UNION (sim->u, 2026-07-19) like upstream, so a wrong-type setter no longer writes
//   an unused member harmlessly -- it aliases and corrupts the ACTIVE payload (same
//   hazard as upstream; upstream guards with asserts, which the port omits). Sleeping
...
{ b2DistanceJoint* j = &b2Joint_GetSim( w, id )->u.distanceJoint;  j->length = b2MaxFloat( length, B2_LINEAR_SLOP ); }
void  b2DistanceJoint_SetLengthRange( b2World* w, b2JointId* id, float minLength, float maxLength )
{ b2DistanceJoint* j = &b2Joint_GetSim( w, id )->u.distanceJoint;
  j->minLength = b2MaxFloat( minLength, B2_LINEAR_SLOP );  j->maxLength = b2MaxFloat( j->minLength, maxLength ); }
void  b2DistanceJoint_EnableSpring( b2World* w, b2JointId* id, bool e ) { b2Joint_GetSim( w, id )->u.distanceJoint.enableSpring = e; }
void  b2DistanceJoint_SetSpringHertz( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.distanceJoint.hertz = v; }
void  b2DistanceJoint_SetSpringDampingRatio( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.distanceJoint.dampingRatio = v; }
void  b2DistanceJoint_EnableLimit( b2World* w, b2JointId* id, bool e ) { b2Joint_GetSim( w, id )->u.distanceJoint.enableLimit = e; }
void  b2DistanceJoint_EnableMotor( b2World* w, b2JointId* id, bool e ) { b2Joint_GetSim( w, id )->u.distanceJoint.enableMotor = e; }
void  b2DistanceJoint_SetMotorSpeed( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.distanceJoint.motorSpeed = v; }
void  b2DistanceJoint_SetMaxMotorForce( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.distanceJoint.maxMotorForce = v; }
float b2DistanceJoint_GetLength( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.distanceJoint.length; }

// ---- revolute ----
void b2RevoluteJoint_EnableMotor( b2World* w, b2JointId* id, bool e ) { b2Joint_GetSim( w, id )->u.revoluteJoint.enableMotor = e; }
void b2RevoluteJoint_SetMotorSpeed( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.revoluteJoint.motorSpeed = v; }
void b2RevoluteJoint_SetMaxMotorTorque( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.revoluteJoint.maxMotorTorque = v; }
void b2RevoluteJoint_EnableLimit( b2World* w, b2JointId* id, bool e ) { b2Joint_GetSim( w, id )->u.revoluteJoint.enableLimit = e; }
void b2RevoluteJoint_SetLimits( b2World* w, b2JointId* id, float lo, float hi )
{ b2RevoluteJoint* j = &b2Joint_GetSim( w, id )->u.revoluteJoint;  j->lowerAngle = b2MinFloat( lo, hi );  j->upperAngle = b2MaxFloat( lo, hi ); }
void b2RevoluteJoint_EnableSpring( b2World* w, b2JointId* id, bool e ) { b2Joint_GetSim( w, id )->u.revoluteJoint.enableSpring = e; }
void b2RevoluteJoint_SetSpringHertz( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.revoluteJoint.hertz = v; }
void b2RevoluteJoint_SetSpringDampingRatio( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.revoluteJoint.dampingRatio = v; }
void b2RevoluteJoint_SetTargetAngle( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.revoluteJoint.targetAngle = v; }
...
// ---- prismatic ----
void b2PrismaticJoint_EnableMotor( b2World* w, b2JointId* id, bool e ) { b2Joint_GetSim( w, id )->u.prismaticJoint.enableMotor = e; }
void b2PrismaticJoint_SetMotorSpeed( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.prismaticJoint.motorSpeed = v; }
void b2PrismaticJoint_SetMaxMotorForce( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.prismaticJoint.maxMotorForce = v; }
void b2PrismaticJoint_EnableLimit( b2World* w, b2JointId* id, bool e ) { b2Joint_GetSim( w, id )->u.prismaticJoint.enableLimit = e; }
void b2PrismaticJoint_SetLimits( b2World* w, b2JointId* id, float lo, float hi )
{ b2PrismaticJoint* j = &b2Joint_GetSim( w, id )->u.prismaticJoint;  j->lowerTranslation = b2MinFloat( lo, hi );  j->upperTranslation = b2MaxFloat( lo, hi ); }
void b2PrismaticJoint_EnableSpring( b2World* w, b2JointId* id, bool e ) { b2Joint_GetSim( w, id )->u.prismaticJoint.enableSpring = e; }
void b2PrismaticJoint_SetSpringHertz( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.prismaticJoint.hertz = v; }
void b2PrismaticJoint_SetSpringDampingRatio( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.prismaticJoint.dampingRatio = v; }
void b2PrismaticJoint_SetTargetTranslation( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.prismaticJoint.targetTranslation = v; }
...
// ---- wheel ----
void b2WheelJoint_EnableMotor( b2World* w, b2JointId* id, bool e ) { b2Joint_GetSim( w, id )->u.wheelJoint.enableMotor = e; }
void b2WheelJoint_SetMotorSpeed( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.wheelJoint.motorSpeed = v; }
void b2WheelJoint_SetMaxMotorTorque( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.wheelJoint.maxMotorTorque = v; }
void b2WheelJoint_EnableLimit( b2World* w, b2JointId* id, bool e ) { b2Joint_GetSim( w, id )->u.wheelJoint.enableLimit = e; }
void b2WheelJoint_SetLimits( b2World* w, b2JointId* id, float lo, float hi )
{ b2WheelJoint* j = &b2Joint_GetSim( w, id )->u.wheelJoint;  j->lowerTranslation = b2MinFloat( lo, hi );  j->upperTranslation = b2MaxFloat( lo, hi ); }
void b2WheelJoint_EnableSpring( b2World* w, b2JointId* id, bool e ) { b2Joint_GetSim( w, id )->u.wheelJoint.enableSpring = e; }
void b2WheelJoint_SetSpringHertz( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.wheelJoint.hertz = v; }
void b2WheelJoint_SetSpringDampingRatio( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.wheelJoint.dampingRatio = v; }
...
// ---- weld ----
void b2WeldJoint_SetLinearHertz( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.weldJoint.linearHertz = v; }
void b2WeldJoint_SetLinearDampingRatio( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.weldJoint.linearDampingRatio = v; }
void b2WeldJoint_SetAngularHertz( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.weldJoint.angularHertz = v; }
void b2WeldJoint_SetAngularDampingRatio( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.weldJoint.angularDampingRatio = v; }

// ---- motor ----
void b2MotorJoint_SetLinearVelocity( b2World* w, b2JointId* id, b2Vec2* v ) { b2Joint_GetSim( w, id )->u.motorJoint.linearVelocity = *v; }
void b2MotorJoint_SetAngularVelocity( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.motorJoint.angularVelocity = v; }
void b2MotorJoint_SetMaxVelocityForce( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.motorJoint.maxVelocityForce = v; }
void b2MotorJoint_SetMaxVelocityTorque( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.motorJoint.maxVelocityTorque = v; }
void b2MotorJoint_SetLinearHertz( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.motorJoint.linearHertz = v; }
void b2MotorJoint_SetLinearDampingRatio( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.motorJoint.linearDampingRatio = v; }
void b2MotorJoint_SetAngularHertz( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.motorJoint.angularHertz = v; }
void b2MotorJoint_SetAngularDampingRatio( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.motorJoint.angularDampingRatio = v; }
...
// ---- distance ----
float b2DistanceJoint_GetMinLength( b2World* w, b2JointId* id )  { return b2Joint_GetSim( w, id )->u.distanceJoint.minLength; }
float b2DistanceJoint_GetMaxLength( b2World* w, b2JointId* id )  { return b2Joint_GetSim( w, id )->u.distanceJoint.maxLength; }
bool  b2DistanceJoint_IsSpringEnabled( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.distanceJoint.enableSpring; }
float b2DistanceJoint_GetSpringHertz( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.distanceJoint.hertz; }
float b2DistanceJoint_GetSpringDampingRatio( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.distanceJoint.dampingRatio; }
bool  b2DistanceJoint_IsLimitEnabled( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.distanceJoint.enableLimit; }
bool  b2DistanceJoint_IsMotorEnabled( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.distanceJoint.enableMotor; }
float b2DistanceJoint_GetMotorSpeed( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.distanceJoint.motorSpeed; }
float b2DistanceJoint_GetMaxMotorForce( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.distanceJoint.maxMotorForce; }
void  b2DistanceJoint_SetSpringForceRange( b2World* w, b2JointId* id, float lower, float upper )
{ b2DistanceJoint* j = &b2Joint_GetSim( w, id )->u.distanceJoint;  j->lowerSpringForce = b2MinFloat( lower, upper );  j->upperSpringForce = b2MaxFloat( lower, upper ); }
void  b2DistanceJoint_GetSpringForceRange( b2World* w, b2JointId* id, float* lower, float* upper )
{ b2DistanceJoint* j = &b2Joint_GetSim( w, id )->u.distanceJoint;  *lower = j->lowerSpringForce;  *upper = j->upperSpringForce; }

// ---- revolute ----
bool  b2RevoluteJoint_IsSpringEnabled( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.revoluteJoint.enableSpring; }
float b2RevoluteJoint_GetSpringHertz( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.revoluteJoint.hertz; }
float b2RevoluteJoint_GetSpringDampingRatio( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.revoluteJoint.dampingRatio; }
float b2RevoluteJoint_GetTargetAngle( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.revoluteJoint.targetAngle; }
bool  b2RevoluteJoint_IsMotorEnabled( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.revoluteJoint.enableMotor; }
float b2RevoluteJoint_GetMotorSpeed( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.revoluteJoint.motorSpeed; }
float b2RevoluteJoint_GetMaxMotorTorque( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.revoluteJoint.maxMotorTorque; }
bool  b2RevoluteJoint_IsLimitEnabled( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.revoluteJoint.enableLimit; }
float b2RevoluteJoint_GetLowerLimit( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.revoluteJoint.lowerAngle; }
float b2RevoluteJoint_GetUpperLimit( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.revoluteJoint.upperAngle; }

// ---- prismatic ----
bool  b2PrismaticJoint_IsSpringEnabled( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.prismaticJoint.enableSpring; }
float b2PrismaticJoint_GetSpringHertz( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.prismaticJoint.hertz; }
float b2PrismaticJoint_GetSpringDampingRatio( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.prismaticJoint.dampingRatio; }
float b2PrismaticJoint_GetTargetTranslation( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.prismaticJoint.targetTranslation; }
bool  b2PrismaticJoint_IsMotorEnabled( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.prismaticJoint.enableMotor; }
float b2PrismaticJoint_GetMotorSpeed( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.prismaticJoint.motorSpeed; }
float b2PrismaticJoint_GetMaxMotorForce( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.prismaticJoint.maxMotorForce; }
bool  b2PrismaticJoint_IsLimitEnabled( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.prismaticJoint.enableLimit; }
float b2PrismaticJoint_GetLowerLimit( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.prismaticJoint.lowerTranslation; }
float b2PrismaticJoint_GetUpperLimit( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.prismaticJoint.upperTranslation; }

// ---- wheel ----
bool  b2WheelJoint_IsSpringEnabled( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.wheelJoint.enableSpring; }
float b2WheelJoint_GetSpringHertz( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.wheelJoint.hertz; }
float b2WheelJoint_GetSpringDampingRatio( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.wheelJoint.dampingRatio; }
bool  b2WheelJoint_IsMotorEnabled( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.wheelJoint.enableMotor; }
float b2WheelJoint_GetMotorSpeed( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.wheelJoint.motorSpeed; }
float b2WheelJoint_GetMaxMotorTorque( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.wheelJoint.maxMotorTorque; }
bool  b2WheelJoint_IsLimitEnabled( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.wheelJoint.enableLimit; }
float b2WheelJoint_GetLowerLimit( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.wheelJoint.lowerTranslation; }
float b2WheelJoint_GetUpperLimit( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.wheelJoint.upperTranslation; }

// ---- weld ----
float b2WeldJoint_GetLinearHertz( b2World* w, b2JointId* id )  { return b2Joint_GetSim( w, id )->u.weldJoint.linearHertz; }
float b2WeldJoint_GetLinearDampingRatio( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.weldJoint.linearDampingRatio; }
float b2WeldJoint_GetAngularHertz( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.weldJoint.angularHertz; }
float b2WeldJoint_GetAngularDampingRatio( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.weldJoint.angularDampingRatio; }

// ---- motor ----
void  b2MotorJoint_GetLinearVelocity( b2World* w, b2JointId* id, b2Vec2* result ) { *result = b2Joint_GetSim( w, id )->u.motorJoint.linearVelocity; }
float b2MotorJoint_GetAngularVelocity( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.motorJoint.angularVelocity; }
float b2MotorJoint_GetMaxVelocityForce( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.motorJoint.maxVelocityForce; }
float b2MotorJoint_GetMaxVelocityTorque( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.motorJoint.maxVelocityTorque; }
float b2MotorJoint_GetLinearHertz( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.motorJoint.linearHertz; }
float b2MotorJoint_GetLinearDampingRatio( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.motorJoint.linearDampingRatio; }
float b2MotorJoint_GetAngularHertz( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.motorJoint.angularHertz; }
float b2MotorJoint_GetAngularDampingRatio( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.motorJoint.angularDampingRatio; }
void  b2MotorJoint_SetMaxSpringForce( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.motorJoint.maxSpringForce = v; }
float b2MotorJoint_GetMaxSpringForce( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.motorJoint.maxSpringForce; }
void  b2MotorJoint_SetMaxSpringTorque( b2World* w, b2JointId* id, float v ) { b2Joint_GetSim( w, id )->u.motorJoint.maxSpringTorque = v; }
float b2MotorJoint_GetMaxSpringTorque( b2World* w, b2JointId* id ) { return b2Joint_GetSim( w, id )->u.motorJoint.maxSpringTorque; }
...
{ return w->inv_h * b2Joint_GetSim( w, id )->u.distanceJoint.motorImpulse; }
float b2RevoluteJoint_GetMotorTorque( b2World* w, b2JointId* id )
{ return w->inv_h * b2Joint_GetSim( w, id )->u.revoluteJoint.motorImpulse; }
float b2PrismaticJoint_GetMotorForce( b2World* w, b2JointId* id )
{ return w->inv_h * b2Joint_GetSim( w, id )->u.prismaticJoint.motorImpulse; }
float b2WheelJoint_GetMotorTorque( b2World* w, b2JointId* id )
{ return w->inv_h * b2Joint_GetSim( w, id )->u.wheelJoint.motorImpulse; }
...
void b2GetJointConstraintForce( b2World* world, b2Joint* joint, b2Vec2* result )
{
    ...
    {
        b2MulSV( inv_h, &base->u.revoluteJoint.linearImpulse, result );
    }
    else if( joint->type == b2_weldJoint )
    {
        b2MulSV( inv_h, &base->u.weldJoint.linearImpulse, result );
    }
    else if( joint->type == b2_motorJoint )
    {
        b2Vec2 sum;  b2Add( &base->u.motorJoint.linearVelocityImpulse, &base->u.motorJoint.linearSpringImpulse, &sum );
        b2MulSV( inv_h, &sum, result );
    }
    else if( joint->type == b2_distanceJoint )
    {
        // force along the current anchor-to-anchor axis
        b2DistanceJoint* dj = &base->u.distanceJoint;
        b2WorldTransform xfA;  b2GetBodyTransform( world, base->bodyIdA, &xfA );
    ...
    {
        b2PrismaticJoint* pj = &base->u.prismaticJoint;
    ...
    {
        b2WheelJoint* wj = &base->u.wheelJoint;
        b2Vec2 axisA;  b2GetJointAxisA( world, base, &axisA );
        b2Vec2 perpA;  b2LeftPerp( &axisA, &perpA );
...
float b2GetJointConstraintTorque( b2World* world, b2Joint* joint )
{
    ...
    if( joint->type == b2_revoluteJoint )
    {
        b2RevoluteJoint* rj = &base->u.revoluteJoint;
        return inv_h * ( rj->motorImpulse + rj->lowerImpulse - rj->upperImpulse );
    }
    if( joint->type == b2_prismaticJoint )
        return inv_h * base->u.prismaticJoint.impulse.y;
    if( joint->type == b2_wheelJoint )
        return inv_h * base->u.wheelJoint.motorImpulse;
    if( joint->type == b2_weldJoint )
        return inv_h * base->u.weldJoint.angularImpulse;
    if( joint->type == b2_motorJoint )
        return inv_h * ( base->u.motorJoint.angularVelocityImpulse + base->u.motorJoint.angularSpringImpulse );
...
float b2Joint_GetLinearSeparation( b2World* world, b2JointId* id )
{
    ...
    if( joint->type == b2_weldJoint )
    {
        if( base->u.weldJoint.linearHertz == 0.0 )  return b2Length( &dp );
        return 0.0;
    }
    ...
    if( joint->type == b2_prismaticJoint || joint->type == b2_wheelJoint )
    {
        ...
        if( joint->type == b2_prismaticJoint )
        {
            enableLimit = base->u.prismaticJoint.enableLimit;
            lower = base->u.prismaticJoint.lowerTranslation;
            upper = base->u.prismaticJoint.upperTranslation;
        }
        else
        {
            enableLimit = base->u.wheelJoint.enableLimit;
            lower = base->u.wheelJoint.lowerTranslation;
            upper = base->u.wheelJoint.upperTranslation;
        }
        if( enableLimit )
        {
...
float b2Joint_GetAngularSeparation( b2World* world, b2JointId* id )
{
    ...
    if( joint->type == b2_weldJoint )
    {
        if( base->u.weldJoint.angularHertz == 0.0 )  return relativeAngle;
        return 0.0;
    }
