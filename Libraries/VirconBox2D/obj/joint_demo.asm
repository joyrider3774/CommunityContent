...
__if_61704_end:
  ...
  mov CR, 3
  movs
__for_61636_continue:
  mov R0, [BP-161]
  mov R1, R0
  iadd R1, 1
  mov [BP-161], R1
  jmp __for_61636_start
__for_61636_end:
  lea R1, [BP-183]
  mov [SP], R1
  call __function_b2DefaultBodyDef
  ...
  mov [BP-280], R0
__while_61877_start:
__while_61877_continue:
  mov R0, 1
  jf R0, __while_61877_end
  mov R0, [BP-280]
  iadd R0, 1
  mov [BP-280], R0
...
__for_61961_start:
  ...
  mov R1, [BP-337]
  mov [SP+1], R1
  mov R1, __literal_string_61988
  mov [SP+2], R1
  call __function_print_at
__for_61961_continue:
  mov R0, [BP-286]
  mov R1, R0
  iadd R1, 1
  mov [BP-286], R1
  jmp __for_61961_start
__for_61961_end:
  lea R2, [BP-84]
  mov [SP], R2
  lea R2, [BP-211]
  ...
  mov R1, [BP-337]
  mov [SP+1], R1
  mov R1, __literal_string_62051
  mov [SP+2], R1
  call __function_print_at
  call __function_end_frame
  jmp __while_61877_start
__while_61877_end:
...
__literal_string_1105:
  string "-2147483648"
__literal_string_61917:
  string "VIRCONBOX2D -- MOTOR WHACKS ROPE"
__literal_string_61921:
  string "FPS"
__literal_string_61929:
  string "STEP CYC"
__literal_string_61939:
  string "T"
__literal_string_61945:
  string "+"
__literal_string_61988:
  string "o"
__literal_string_62035:
  string "*"
__literal_string_62051:
  string "*"
