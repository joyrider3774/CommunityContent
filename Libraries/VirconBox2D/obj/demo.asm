...
__function_b2Body_GetWorldCenter:
  push BP
  mov BP, SP
  isub SP, 4
  mov R1, [BP+2]
  ...
  mov CR, 2
  movs
__function_b2Body_GetWorldCenter_return:
  mov SP, BP
  pop BP
  ret
...
__for_61698_start:
  ...
  iadd R0, 1
  mov [BP-205], R0
__for_61698_continue:
  mov R0, [BP-206]
  mov R1, R0
  iadd R1, 1
  mov [BP-206], R1
  jmp __for_61698_start
__for_61698_end:
  mov R0, 0.016667
  mov [BP-207], R0
  mov R0, 0
  ...
  mov [BP-209], R0
__while_61786_start:
__while_61786_continue:
  mov R0, 1
  jf R0, __while_61786_end
  mov R0, [BP-208]
  iadd R0, 1
  mov [BP-208], R0
__if_61794_start:
  mov R0, [BP-208]
  ieq R0, 180
  jf R0, __LogicalAnd_ShortCircuit_61799
  mov R1, [BP-209]
  ieq R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_61799:
  jf R0, __if_61794_end
  mov R0, 1
  mov [BP-209], R0
  lea R1, [BP-236]
  mov [SP], R1
...
__if_61931_start:
  mov R0, [BP-209]
  ieq R0, 0
  jf R0, __if_61931_else
  mov R1, 12
  mov [SP], R1
  mov R1, 46
  mov [SP+1], R1
  mov R1, __literal_string_61938
  mov [SP+2], R1
  call __function_print_at
  jmp __if_61931_end
__if_61931_else:
...
__for_61945_start:
  ...
  mov R1, [BP-243]
  mov [SP+1], R1
  mov R1, __literal_string_61963
  mov [SP+2], R1
  call __function_print_at
__for_61945_continue:
  mov R0, [BP-213]
  fadd R0, 0.500000
  mov [BP-213], R0
  jmp __for_61945_start
__for_61945_end:
  mov R0, 0
  mov [BP-214], R0
__for_61966_start:
  ...
  lea R1, [BP-216]
  mov [SP+2], R1
  call __function_b2Body_GetWorldCenter
  mov R2, [BP-215]
  mov [SP], R2
  call __function_ScreenY
  mov R1, R0
  ...
  mov R1, [BP-243]
  mov [SP+1], R1
  mov R1, __literal_string_61994
  mov [SP+2], R1
  call __function_print_at
__for_61966_continue:
  mov R0, [BP-214]
  mov R1, R0
  iadd R1, 1
  mov [BP-214], R1
  jmp __for_61966_start
__for_61966_end:
  call __function_end_frame
  jmp __while_61786_start
__while_61786_end:
...
__literal_string_1105:
  string "-2147483648"
__literal_string_61914:
  string "VIRCONBOX2D -- LIVE PHYSICS"
__literal_string_61918:
  string "FPS"
__literal_string_61926:
  string "STEP CYC"
__literal_string_61938:
  string "TOWER SETTLING..."
__literal_string_61942:
  string "INCOMING BOX -> COLLAPSE!"
__literal_string_61963:
  string "="
__literal_string_61994:
  string "[]"
