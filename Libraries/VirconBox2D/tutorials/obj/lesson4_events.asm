...
__if_1427_start:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_1429
  mov R2, [BP-1]
  iadd R2, 3
  mov R1, [R2]
  and R0, R1
__LogicalAnd_ShortCircuit_1429:
  jf R0, __if_1427_end
  mov R0, [BP-2]
  mov R1, [BP-1]
  iadd R1, 1
...
__if_1531_start:
  ...
  ine R0, -1
  bnot R0
  jt R0, __LogicalOr_ShortCircuit_1534
  mov R2, [BP-2]
  iadd R2, 3
  mov R1, [R2]
  bnot R1
  or R0, R1
__LogicalOr_ShortCircuit_1534:
  jf R0, __if_1531_end
  mov R0, 0
  jmp __function_expand_malloc_block_return
__if_1531_end:
...
__if_1611_end:
  ...
  mov [BP-1], R0
__while_1620_start:
__while_1620_continue:
  mov R0, [BP-1]
  ine R0, -1
  jf R0, __while_1620_end
__if_1623_start:
  mov R1, [BP-1]
  iadd R1, 3
  mov R0, [R1]
  jf R0, __LogicalAnd_ShortCircuit_1626
  mov R2, [BP-1]
  iadd R2, 2
  mov R1, [R2]
  mov R2, [BP+2]
  ige R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_1626:
  jf R0, __if_1623_end
  jmp __while_1620_end
__if_1623_end:
  mov R1, [BP-1]
  iadd R1, 1
  mov R0, [R1]
  mov [BP-1], R0
  jmp __while_1620_start
__while_1620_end:
__if_1636_start:
  mov R0, [BP-1]
  ine R0, -1
...
__if_62886_start:
  mov R1, [BP+2]
  ilt R1, 0
  jt R1, __LogicalOr_ShortCircuit_62891
  mov R2, [BP+2]
  ...
  ige R2, R3
  or R1, R2
__LogicalOr_ShortCircuit_62891:
  mov R0, R1
  jf R0, __if_62886_end
  mov R0, -1
...
__if_62912_start:
  mov R1, [BP+2]
  ilt R1, 0
  jt R1, __LogicalOr_ShortCircuit_62917
  mov R2, [BP+2]
  mov R4, global_vb2_world
  mov [SP], R4
  call __function_b2World_GetBeginTouchEventCount
  ...
  ige R2, R3
  or R1, R2
__LogicalOr_ShortCircuit_62917:
  mov R0, R1
  jf R0, __if_62912_end
  mov R0, -1
...
__if_63343_start:
  ...
  mov R1, [BP+2]
  ieq R0, R1
  jf R0, __if_63343_end
  mov R0, 1
  jmp __function_IsCrate_return
__if_63343_end:
__for_63334_continue:
  mov R0, [BP-1]
  mov R1, R0
  iadd R1, 1
  mov [BP-1], R1
  jmp __for_63334_start
__for_63334_end:
  mov R0, 0
...
__for_63398_start:
  mov R0, [BP-2]
  ilt R0, 12
  jf R0, __for_63398_end
  mov R0, -1
  mov R1, global_crates
  mov R2, [BP-2]
  iadd R1, R2
  mov [R1], R0
__for_63398_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_63398_start
__for_63398_end:
  mov R0, 0
  mov [BP-3], R0
  mov R0, 0
...
__while_63424_start:
__while_63424_continue:
  mov R0, 1
  jf R0, __while_63424_end
  mov R0, [BP-5]
  isub R0, 1
  mov [BP-5], R0
__if_63432_start:
...
__if_63449_start:
  ...
  jmp __for_63440_end
__if_63449_end:
__for_63440_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_63440_start
__for_63440_end:
__if_63432_end:
__if_63474_start:
...
__if_63559_start:
  mov R1, [BP-24]
  ine R1, -1
  jf R1, __LogicalAnd_ShortCircuit_63566
  mov R3, [BP-24]
  mov [SP], R3
  call __function_IsCrate
  mov R2, R0
  and R1, R2
__LogicalAnd_ShortCircuit_63566:
  mov R0, R1
  jf R0, __if_63559_end
  mov R0, [BP-24]
  lea R1, [BP-17]
  mov R2, [BP-18]
  iadd R1, R2
  ...
  mov [BP-18], R0
__if_63559_end:
__for_63523_continue:
  mov R0, [BP-19]
  mov R1, R0
  iadd R1, 1
  mov [BP-19], R1
  jmp __for_63523_start
__for_63523_end:
  mov R0, 0
  mov [BP-2], R0
__for_63578_start:
...
__if_63587_start:
  ...
  mov [BP-4], R0
__if_63587_end:
__for_63578_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_63578_start
__for_63578_end:
  mov R0, 0
  mov [BP-2], R0
__for_63605_start:
...
__if_63614_start:
  ...
  call __function_vb2_Exists
  mov R1, R0
  jf R1, __LogicalAnd_ShortCircuit_63619
  ...
  flt R2, -20.000000
  and R1, R2
__LogicalAnd_ShortCircuit_63619:
  mov R0, R1
  jf R0, __if_63614_end
  mov R1, global_crates
  mov R2, [BP-2]
  iadd R1, R2
  mov R1, [R1]
  ...
  call __function_vb2_Destroy
__if_63614_end:
__for_63605_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_63605_start
__for_63605_end:
  mov R1, -16777216
  mov [SP], R1
...
__for_63667_start:
  ...
  mov [SP+2], R1
  call __function_print_at
__for_63667_continue:
  mov R0, [BP-20]
  fadd R0, 0.500000
  mov [BP-20], R0
  jmp __for_63667_start
__for_63667_end:
  mov R0, -7.000000
  mov [BP-21], R0
__for_63689_start:
  ...
  mov R1, [BP-25]
  mov [SP+1], R1
  mov R1, __literal_string_63715
  mov [SP+2], R1
  call __function_print_at
__for_63689_continue:
  mov R0, [BP-21]
  fadd R0, 0.500000
  mov [BP-21], R0
  jmp __for_63689_start
__for_63689_end:
  mov R0, 0
  mov [BP-2], R0
__for_63716_start:
...
__if_63725_start:
  ...
  call __function_print_at
__if_63725_end:
__for_63716_continue:
  mov R0, [BP-2]
  mov R1, R0
  iadd R1, 1
  mov [BP-2], R1
  jmp __for_63716_start
__for_63716_end:
  mov R3, [global_player]
  mov [SP], R3
  call __function_vb2_GetY
  mov R2, R0
  mov [BP-25], R2
...
__literal_string_1146:
  string "-2147483648"
__literal_string_63638:
  string "LESSON 4: CRATE CRUSHER"
__literal_string_63642:
  string "RAM THE FALLING CRATES"
__literal_string_63646:
  string "SCORE"
__literal_string_63664:
  string "CRUSHED!"
__literal_string_63686:
  string "="
__literal_string_63709:
  string "|"
__literal_string_63715:
  string "|"
