...
; location of global variables
  ...
  %define global_W 17
  %define global_gColR 18
  %define global_gColG 82
  %define global_gColB 146
  %define global_gCarId 210
  %define global_gWheelIdL 213
  %define global_gWheelIdR 216
  %define global_gMotorL 219
  %define global_gMotorR 222
  %define global_gBallId 225
  %define global_gRopeAnchorX 228
  %define global_gRopeAnchorY 229
  %define global_gSpawnIdx1 230
  %define global_gSpawnGen 236
  %define global_gSpawnCount 242
  %define global_gSpawnHead 243
  %define global_gSpawnKind 244
  %define global_gFaceDir 245
  %define global_gFlipped 246
  %define global_gPrevX 247
  %define global_gPrevY 311
  %define global_gPrevC 375
  %define global_gPrevS 439
  %define global_gStepCyc 503
  %define global_gWorkCyc 504
  %define global_gSubSteps 505
...
__if_1641_start:
  ...
  mov R1, [BP-8]
  ieq R0, R1
  jf R0, __LogicalAnd_ShortCircuit_1646
  mov R1, [BP-5]
  mov R2, [BP-9]
  ieq R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_1646:
  jf R0, __if_1641_else
  mov R1, [BP-4]
  mov [SP], R1
  mov R1, [BP-5]
  mov [SP+1], R1
...
__if_1694_start:
  mov R0, [BP-2]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_1699
  mov R1, [BP-1]
  ige R1, 360
  or R0, R1
__LogicalOr_ShortCircuit_1699:
  jf R0, __if_1694_end
...
__function_b2DefaultWheelJointDef:
  push BP
  mov BP, SP
  isub SP, 3
  mov R1, [BP+2]
  ...
  mov CR, 2
  movs
__function_b2DefaultWheelJointDef_return:
  mov SP, BP
  pop BP
  ret

__function_b2CreateWheelJointDef:
  push BP
  mov BP, SP
  isub SP, 10
  mov R1, [BP+3]
  ...
  mov R1, [R2]
  mov [SP+5], R1
  call __function_b2CreateWheelJoint
  mov [BP-3], R0
  mov R5, [BP+2]
  mov [SP], R5
  mov R5, [BP-3]
  ...
  mov [SP+2], R1
  call __function_b2MakeJointId
__function_b2CreateWheelJointDef_return:
  mov SP, BP
  pop BP
  ret
...
__function_b2WheelJoint_SetMotorSpeed:
  push BP
  mov BP, SP
  isub SP, 2
  mov R1, [BP+4]
  ...
  mov [R2], R1
  mov R0, R1
__function_b2WheelJoint_SetMotorSpeed_return:
  mov SP, BP
  pop BP
  ret
...
__function_SelectWhitePixel:
  push BP
  mov BP, SP
  out GPU_SelectedTexture, -1
  out GPU_SelectedRegion, 256
__function_SelectWhitePixel_return:
  mov SP, BP
  pop BP
  ret

__function_DrawWorldBox:
  push BP
  mov BP, SP
  isub SP, 9
  mov R0, [BP+2]
  ...
  mov [SP+1], R1
  call __function_set_drawing_scale
  call __function_SelectWhitePixel
  mov R1, [BP-5]
  cfi R1
  mov [SP], R1
  mov R1, [BP-6]
  ...
  mov [SP+1], R1
  call __function_draw_region_rotozoomed_at
__function_DrawWorldBox_return:
  mov SP, BP
  pop BP
  ret

__function_DrawWorldLine:
  push BP
  mov BP, SP
  isub SP, 8
  mov R1, [BP+6]
...
__function_DrawWorldLine_return:
  mov SP, BP
  pop BP
  ret
...
__if_62536_start:
  ...
  call __function_b2WakeSolverSet
__if_62536_end:
__function_WakeBody_return:
  mov SP, BP
  pop BP
  ret

__function_PokeVelocity:
  push BP
  mov BP, SP
  isub SP, 5
  mov R1, [BP+2]
  mov [SP], R1
  call __function_WakeBody
  mov R1, [global_W]
  mov [SP], R1
  mov R1, [BP+2]
  mov [SP+1], R1
...
__if_62557_start:
  ...
  mov [R1], R0
__if_62557_end:
__function_PokeVelocity_return:
  mov SP, BP
  pop BP
  ret
...
__if_62617_start:
  ...
  mov R0, [R1]
  ine R0, -1
  jf R0, __LogicalAnd_ShortCircuit_62627
  mov R2, [BP-2]
  iadd R2, 1
  mov R1, [R2]
  igt R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_62627:
  jf R0, __if_62617_end
  mov R1, [global_W]
  mov [SP], R1
  mov R1, [BP-1]
  mov [SP+1], R1
  call __function_b2WakeSolverSet
__if_62617_end:
__for_62597_continue:
  mov R0, [BP-1]
  iadd R0, 1
  mov [BP-1], R0
  jmp __for_62597_start
__for_62597_end:
__function_WakeAll_return:
  mov SP, BP
  pop BP
  ret

__function_SetBodyColor:
  push BP
  mov BP, SP
  isub SP, 1
  mov R1, [BP+2]
...
__if_62644_start:
  mov R0, [BP-1]
  ige R0, 0
  jf R0, __LogicalAnd_ShortCircuit_62649
  mov R1, [BP-1]
  ilt R1, 64
  and R0, R1
__LogicalAnd_ShortCircuit_62649:
  jf R0, __if_62644_end
  mov R0, [BP+3]
  mov R1, global_gColR
  mov R2, [BP-1]
  iadd R1, R2
  ...
  mov [R1], R0
__if_62644_end:
__function_SetBodyColor_return:
  mov SP, BP
  pop BP
  ret

__function_MakeStaticBox:
  push BP
  mov BP, SP
  isub SP, 78
  lea R1, [BP-22]
  ...
  mov R1, [BP+9]
  mov [SP+3], R1
  call __function_SetBodyColor
__function_MakeStaticBox_return:
  mov SP, BP
  pop BP
  ret

__function_SpawnDrop:
  push BP
  mov BP, SP
  isub SP, 82
__if_62737_start:
  mov R0, [global_gSpawnCount]
  ieq R0, 6
  jf R0, __if_62737_end
  mov R0, global_gSpawnIdx1
  mov R1, [global_gSpawnHead]
  iadd R0, R1
  mov R0, [R0]
  mov [BP-41], R0
  mov R0, 0
  mov [BP-40], R0
  mov R0, global_gSpawnGen
  mov R1, [global_gSpawnHead]
  iadd R0, R1
  mov R0, [R0]
  mov [BP-39], R0
  ...
  mov R0, [global_gSpawnHead]
  iadd R0, 1
  imod R0, 6
  mov [global_gSpawnHead], R0
  mov R0, [global_gSpawnCount]
  isub R0, 1
  mov [global_gSpawnCount], R0
__if_62737_end:
  lea R1, [BP-22]
  mov [SP], R1
  call __function_b2DefaultBodyDef
  ...
  call __function_b2DefaultShapeDef
__if_62823_start:
  mov R0, [global_gSpawnKind]
  ieq R0, 1
  jf R0, __if_62823_else
  mov R0, 1.000000
  mov [BP-37], R0
  mov R0, 0.700000
  mov [BP-36], R0
...
__if_62823_end:
  ...
  iadd R0, 1
  imod R0, 3
  mov [global_gSpawnKind], R0
  mov R0, [global_gSpawnHead]
  mov R1, [global_gSpawnCount]
  iadd R0, R1
  imod R0, 6
  mov [BP-38], R0
  mov R0, [BP-25]
  mov R1, global_gSpawnIdx1
  mov R2, [BP-38]
  iadd R1, R2
  mov [R1], R0
  mov R0, [BP-23]
  mov R1, global_gSpawnGen
  mov R2, [BP-38]
  iadd R1, R2
  mov [R1], R0
  mov R0, [global_gSpawnCount]
  iadd R0, 1
  mov [global_gSpawnCount], R0
__function_SpawnDrop_return:
  mov SP, BP
  pop BP
  ret

__function_RescueCar:
  push BP
  mov BP, SP
  isub SP, 8
  mov R1, global_gCarId
  mov [SP], R1
  mov R1, 0.000000
  mov [SP+1], R1
  mov R1, 0.000000
  ...
  mov R1, 0.000000
  mov [SP+3], R1
  call __function_PokeVelocity
  mov R1, global_gWheelIdL
  mov [SP], R1
  mov R1, 0.000000
  mov [SP+1], R1
  mov R1, 0.000000
...
__if_63067_start:
  mov R0, [BP+4]
  flt R0, 1.000000
  jf R0, __LogicalAnd_ShortCircuit_63072
  mov R1, [BP+2]
  ige R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_63072:
  jf R0, __LogicalAnd_ShortCircuit_63076
  mov R1, [BP+2]
  ilt R1, 64
  and R0, R1
__LogicalAnd_ShortCircuit_63076:
  jf R0, __if_63067_end
  mov R0, global_gPrevX
  mov R1, [BP+2]
  iadd R0, R1
  mov R0, [R0]
  mov R1, [BP-1]
  mov R2, global_gPrevX
  mov R3, [BP+2]
  iadd R2, R3
  mov R2, [R2]
  fsub R1, R2
  ...
  fadd R0, R1
  mov [BP-1], R0
  mov R0, global_gPrevY
  mov R1, [BP+2]
  iadd R0, R1
  mov R0, [R0]
  mov R1, [BP-2]
  mov R2, global_gPrevY
  mov R3, [BP+2]
  iadd R2, R3
  mov R2, [R2]
  fsub R1, R2
  ...
  fadd R0, R1
  mov [BP-2], R0
  mov R0, global_gPrevC
  mov R1, [BP+2]
  iadd R0, R1
  mov R0, [R0]
  mov R1, [BP-3]
  mov R2, global_gPrevC
  mov R3, [BP+2]
  iadd R2, R3
  mov R2, [R2]
  fsub R1, R2
  ...
  fadd R0, R1
  mov [BP-3], R0
  mov R0, global_gPrevS
  mov R1, [BP+2]
  iadd R0, R1
  mov R0, [R0]
  mov R1, [BP-4]
  mov R2, global_gPrevS
  mov R3, [BP+2]
  iadd R2, R3
  mov R2, [R2]
  fsub R1, R2
...
__if_63067_end:
  ...
  mov R1, [R1]
  mov [R1], R0
__function_GetPose_return:
  mov SP, BP
  pop BP
  ret

__function_SnapshotPoses:
  push BP
  mov BP, SP
  isub SP, 5
  mov R0, 0
...
__for_63183_start:
  ...
  mov R1, [R2]
  ilt R0, R1
  jf R0, __LogicalAnd_ShortCircuit_63193
  mov R1, [BP-1]
  ilt R1, 64
  and R0, R1
__LogicalAnd_ShortCircuit_63193:
  jf R0, __for_63183_end
  mov R1, [global_W]
  iadd R1, 4
  mov R0, [R1]
  mov R1, [BP-1]
...
__if_63207_start:
  ...
  mov R0, [R1]
  ieq R0, -1
  jf R0, __if_63207_end
  jmp __for_63183_continue
__if_63207_end:
  mov R1, [global_W]
  mov [SP], R1
  mov R1, [BP-2]
  ...
  iadd R1, 1
  mov R0, [R1]
  mov R1, global_gPrevS
  mov R2, [BP-1]
  iadd R1, R2
  mov [R1], R0
__for_63183_continue:
  mov R0, [BP-1]
  iadd R0, 1
  mov [BP-1], R0
  jmp __for_63183_start
__for_63183_end:
__function_SnapshotPoses_return:
  mov SP, BP
  pop BP
  ret

__function_DrawAllBodies:
  push BP
  mov BP, SP
  isub SP, 25
  mov R0, 0
...
__if_63274_start:
  ...
  mov R0, [R1]
  ieq R0, -1
  jf R0, __if_63274_end
  jmp __for_63254_continue
__if_63274_end:
  mov R1, [global_W]
  mov [SP], R1
  mov R1, [BP-2]
...
__if_63323_end:
  ...
  lea R1, [BP-12]
  mov [SP+6], R1
  call __function_GetPose
  mov R1, [BP-2]
  iadd R1, 5
  mov R0, [R1]
  mov [BP-13], R0
__while_63371_start:
__while_63371_continue:
  mov R0, [BP-13]
  ine R0, -1
  jf R0, __while_63371_end
  mov R1, [global_W]
  iadd R1, 18
  mov R0, [R1]
  mov R1, [BP-13]
...
__if_63409_start:
  ...
  cfi R1
  mov [SP+2], R1
  call __function_draw_filled_circle
  mov R1, [BP-5]
  idiv R1, 2
  mov [SP], R1
  mov R1, [BP-6]
...
__if_63386_end:
  ...
  mov R0, [R1]
  mov [BP-13], R0
  jmp __while_63371_start
__while_63371_end:
__if_63462_start:
  mov R0, [BP-4]
  jf R0, __if_63462_end
  mov R1, -4144960
  mov [SP], R1
  call __function_set_multiply_color
  mov R2, [BP-10]
  ...
  mov R1, [BP-17]
  mov [SP+1], R1
  mov R1, __literal_string_63476
  mov [SP+2], R1
  call __function_print_at
__if_63462_end:
__for_63254_continue:
  mov R0, [BP-1]
  iadd R0, 1
  mov [BP-1], R0
  jmp __for_63254_start
__for_63254_end:
__function_DrawAllBodies_return:
  mov SP, BP
  pop BP
  ret

__function_DrawScene:
  push BP
  mov BP, SP
  isub SP, 57
  mov R0, 60
  mov [BP-1], R0
__if_63482_start:
  mov R0, [global_gWorkCyc]
  igt R0, 500000
  jf R0, __if_63482_end
  mov R0, 30000000
  mov R1, [global_gWorkCyc]
  idiv R0, R1
  mov [BP-1], R0
__if_63482_end:
  mov R2, 10
  ...
  mov R1, R0
  mov [BP-49], R1
  mov R1, [global_gRopeAnchorX]
  mov [SP], R1
  mov R1, [global_gRopeAnchorY]
  mov [SP+1], R1
  mov R1, [BP-4]
  mov [SP+2], R1
  mov R1, [BP-5]
...
__if_63750_start:
  ...
  mov [BP-36], R0
__if_63772_start:
  mov R0, [global_gFaceDir]
  igt R0, 0
  jf R0, __if_63772_else
  mov R0, [BP-36]
  fadd R0, 0.550000
  mov [BP-36], R0
  jmp __if_63772_end
...
__if_63750_end:
__if_63899_start:
  mov R0, [global_gFlipped]
  jf R0, __if_63899_end
  mov R1, -256
  mov [SP], R1
  call __function_set_multiply_color
  mov R2, 13.700000
...
__if_63899_end:
  ...
  mov R1, 4
  mov [SP+1], R1
  mov R1, __literal_string_63936
  mov [SP+2], R1
  call __function_print_at
  mov R0, [global_gStepCyc]
  idiv R0, 5556
  mov [BP-31], R0
__if_63942_start:
  mov R0, [BP-31]
  igt R0, 180
  jf R0, __if_63942_end
  mov R0, 180
  mov [BP-31], R0
__if_63942_end:
  mov R0, -16711936
...
__if_63970_end:
  ...
  mov R1, 16
  mov [SP+2], R1
  call __function_draw_vertical_line
  mov R1, 380
  mov [SP], R1
  mov R1, 4
  mov [SP+1], R1
  mov R1, __literal_string_63992
  mov [SP+2], R1
  call __function_print_at
  mov R1, [global_W]
  iadd R1, 11
  ...
  mov R1, 22
  mov [SP+1], R1
  mov R1, [global_gSubSteps]
  mov [SP+2], R1
  call __function_ShowInt
__function_DrawScene_return:
  mov SP, BP
  pop BP
  ret
...
__for_64056_start:
  ...
  iadd R1, R2
  mov [R1], R0
__for_64056_continue:
  mov R0, [BP-85]
  iadd R0, 1
  mov [BP-85], R0
  jmp __for_64056_start
__for_64056_end:
  mov R0, 0
  mov [global_gSpawnCount], R0
  mov R0, 0
  ...
  mov [global_gSpawnKind], R0
  mov R0, 1
  mov [global_gFaceDir], R0
  mov R0, 0
  mov [global_gFlipped], R0
  mov R0, 0
  mov [global_gStepCyc], R0
  mov R0, 0
  mov [global_gWorkCyc], R0
  mov R0, 4
  mov [global_gSubSteps], R0
  mov R1, 0
  mov [SP], R1
  ...
  lea R1, [BP-252]
  mov [SP], R1
  call __function_b2DefaultWheelJointDef
  lea R13, [BP-252]
  mov R12, global_gCarId
  mov CR, 3
  movs
  lea R13, [BP-249]
  mov R12, global_gWheelIdL
  mov CR, 3
  movs
  mov R0, -0.750000
  mov [BP-246], R0
  ...
  lea R1, [BP-252]
  mov [SP+1], R1
  mov R1, global_gMotorL
  mov [SP+2], R1
  call __function_b2CreateWheelJointDef
  lea R13, [BP-249]
  mov R12, global_gWheelIdR
  mov CR, 3
  movs
  mov R0, 0.750000
  mov [BP-246], R0
...
__if_64630_else:
  ...
  call __function_SetBodyColor
__if_64630_end:
__for_64565_continue:
  mov R0, [BP-85]
  iadd R0, 1
  mov [BP-85], R0
  jmp __for_64565_start
__for_64565_end:
  mov R0, 8.600000
  mov [global_gRopeAnchorX], R0
  mov R0, 7.600000
  mov [global_gRopeAnchorY], R0
  lea R1, [BP-112]
  mov [SP], R1
  call __function_b2DefaultBodyDef
  mov R0, 0
  mov [BP-112], R0
  mov R0, [global_gRopeAnchorX]
  mov [BP-111], R0
  mov R0, [global_gRopeAnchorY]
  mov [BP-110], R0
  mov R1, [global_W]
  mov [SP], R1
  lea R1, [BP-112]
  ...
  lea R1, [BP-177]
  mov [SP], R1
  call __function_b2DefaultDistanceJointDef
  lea R13, [BP-177]
  lea R12, [BP-115]
  mov CR, 3
  movs
  lea R13, [BP-174]
  mov R12, global_gBallId
  mov CR, 3
  movs
  mov R0, 4.600000
  mov [BP-163], R0
  ...
  lea R1, [BP-180]
  mov [SP+2], R1
  call __function_b2CreateDistanceJointDef
  mov R0, 0.033333
  mov [BP-89], R0
  mov R0, 0
  mov [BP-90], R0
__while_64791_start:
__while_64791_continue:
  mov R0, 1
  jf R0, __while_64791_end
  mov R0, [BP-90]
  iadd R0, 1
  mov [BP-90], R0
  mov R0, 0.000000
...
__if_64826_end:
  ...
  mov R1, [BP-91]
  mov [SP+2], R1
  call __function_b2WheelJoint_SetMotorSpeed
  mov R1, [global_W]
  mov [SP], R1
  mov R1, global_gMotorR
  mov [SP+1], R1
...
__if_64846_start:
  mov R0, [BP-92]
  ieq R0, 1
  jt R0, __LogicalOr_ShortCircuit_64851
  mov R1, [BP-92]
  ieq R1, 2
  or R0, R1
__LogicalOr_ShortCircuit_64851:
  jf R0, __if_64846_end
  mov R0, [BP-90]
  imod R0, 5
  cif R0
  fmul R0, 2.100000
...
__if_64873_start:
  mov R0, [BP-93]
  ieq R0, 1
  jt R0, __LogicalOr_ShortCircuit_64878
  mov R1, [BP-93]
  ieq R1, 2
  or R0, R1
__LogicalOr_ShortCircuit_64878:
  jt R0, __LogicalOr_ShortCircuit_64882
  mov R1, [BP-90]
  ieq R1, 150
  or R0, R1
__LogicalOr_ShortCircuit_64882:
  jf R0, __if_64873_end
  mov R1, global_gBallId
  mov [SP], R1
  mov R1, -11.000000
  mov [SP+1], R1
...
__if_64892_start:
  ...
  igt R1, 0
  mov R0, R1
  jf R0, __if_64892_else
__if_64897_start:
  mov R0, [global_gFlipped]
  ieq R0, 0
  jf R0, __if_64897_end
  mov R0, 1
  mov [global_gFlipped], R0
  call __function_WakeAll
  mov R0, 7.000000
  mov [BP-27], R0
__if_64897_end:
  jmp __if_64892_end
...
__if_64927_start:
  mov R0, [BP-94]
  ieq R0, 1
  jt R0, __LogicalOr_ShortCircuit_64932
  mov R1, [BP-94]
  ieq R1, 2
  or R0, R1
__LogicalOr_ShortCircuit_64932:
  jf R0, __if_64927_end
  call __function_RescueCar
__if_64927_end:
  call __function_CycNow
  mov [BP-95], R0
  mov R1, 1.000000
  mov [SP], R1
  call __function_DrawScene
  call __function_SnapshotPoses
  call __function_CycNow
  mov [BP-96], R0
  mov R1, [global_W]
  mov [SP], R1
...
__if_64962_start:
  mov R0, [global_gStepCyc]
  igt R0, 340000
  jf R0, __LogicalAnd_ShortCircuit_64967
  mov R1, [global_gSubSteps]
  igt R1, 2
  and R0, R1
__LogicalAnd_ShortCircuit_64967:
  jf R0, __if_64962_else
  mov R0, [global_gSubSteps]
  isub R0, 1
  mov [global_gSubSteps], R0
  jmp __if_64962_end
__if_64962_else:
__if_64975_start:
  mov R0, [global_gStepCyc]
  ilt R0, 200000
  jf R0, __LogicalAnd_ShortCircuit_64980
  mov R1, [global_gSubSteps]
  ilt R1, 4
  and R0, R1
__LogicalAnd_ShortCircuit_64980:
  jf R0, __if_64975_end
  mov R0, [global_gSubSteps]
  iadd R0, 1
  mov [global_gSubSteps], R0
__if_64975_end:
...
__if_64989_start:
  ...
  ilt R1, 400000
  mov R0, R1
  jf R0, __if_64989_end
  mov R1, 0.500000
  mov [SP], R1
  call __function_DrawScene
  call __function_end_frame
__if_64989_end:
  jmp __while_64791_start
__while_64791_end:
...
__literal_string_1105:
  string "-2147483648"
__literal_string_63476:
  string "z"
__literal_string_63914:
  string "!! GRAVITY INVERTED !!"
__literal_string_63920:
  string "VIRCONBOX2D MEGADEMO"
__literal_string_63924:
  string "DPAD DRIVE   A DROP   B LASER   X WRECK   Y GRAVITY   START RESCUE"
__literal_string_63928:
  string "FPS"
__literal_string_63936:
  string "PHYS 30HZ"
__literal_string_63992:
  string "CYCLES"
__literal_string_64004:
  string "AWAKE"
__literal_string_64014:
  string "OF"
__literal_string_64025:
  string "SUBSTEPS"
