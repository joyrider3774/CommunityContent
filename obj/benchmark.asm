...
; location of global variables
  ...
  %define global_g_junkyardPusher 19
  %define global_g_allPass 22
  %define global_LX_NAME 23
  %define global_LX_BODY 24
  %define global_LX_CYC 25
  %define global_LX_PCT 26
  %define global_LX_VAL 27
  %define global_LX_FIN 28
...
__global_scope_initialization:
  ...
  mov [global_g_dt], R0
  mov R0, 1
  mov [global_g_allPass], R0
  mov R0, 20
  mov [global_LX_NAME], R0
  mov R0, 200
  mov [global_LX_BODY], R0
  mov R0, 300
  mov [global_LX_CYC], R0
  mov R0, 440
  mov [global_LX_PCT], R0
  mov R0, 500
  mov [global_LX_VAL], R0
  mov R0, 560
  mov [global_LX_FIN], R0
  mov SP, BP
  pop BP
  ret
...
__if_11930_start:
  mov R0, [BP+3]
  ilt R0, 3
  jt R0, __LogicalOr_ShortCircuit_11935
  mov R1, [BP+3]
  igt R1, 8
  or R0, R1
__LogicalOr_ShortCircuit_11935:
  jf R0, __if_11930_end
...
__if_12061_start:
  ...
  mov R1, [BP-23]
  flt R0, R1
  jf R0, __if_12061_end
  mov R0, 0
  mov [BP-110], R0
  jmp __for_12039_end
__if_12061_end:
__for_12039_continue:
  mov R0, [BP-111]
  mov R1, R0
  iadd R1, 1
  mov [BP-111], R1
  jmp __for_12039_start
__for_12039_end:
__if_12070_start:
  mov R0, [BP-110]
  jf R0, __if_12070_end
  lea R13, [BP-20]
  mov R1, [BP-21]
  imul R1, 2
  iadd R13, R1
...
__if_12286_end:
__if_12270_end:
__for_12242_continue:
  mov R0, [BP-107]
  mov R1, R0
  iadd R1, 1
  mov [BP-107], R1
  jmp __for_12242_start
__for_12242_end:
  lea R1, [BP-29]
  mov [SP], R1
  lea R1, [BP-33]
...
__if_12325_start:
  mov R0, [BP-72]
  ieq R0, 0
  jf R0, __LogicalAnd_ShortCircuit_12332
  mov R1, [BP-89]
  ieq R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_12332:
...
__for_12346_start:
  ...
  iadd R1, 1
  mov [R2], R1
__for_12346_continue:
  mov R0, [BP-107]
  mov R1, R0
  iadd R1, 1
  mov [BP-107], R1
  jmp __for_12346_start
__for_12346_end:
  mov R13, [BP+4]
  mov R2, [BP+4]
  iadd R2, 16
...
__for_12380_start:
  ...
  iadd R1, 1
  mov [R2], R1
__for_12380_continue:
  mov R0, [BP-107]
  mov R1, R0
  iadd R1, 1
  mov [BP-107], R1
  jmp __for_12380_start
__for_12380_end:
  mov R0, 1
  mov [BP-106], R0
__while_12407_start:
__while_12407_continue:
  mov R0, [BP-106]
  jf R0, __LogicalAnd_ShortCircuit_12409
  mov R2, [BP+4]
  iadd R2, 16
  mov R1, [R2]
  igt R1, 2
  and R0, R1
__LogicalAnd_ShortCircuit_12409:
  jf R0, __while_12407_end
  mov R0, 0
  mov [BP-106], R0
  mov R0, 0
  mov [BP-107], R0
...
__for_12507_start:
  ...
  mov CR, 2
  movs
__for_12507_continue:
  mov R0, [BP-124]
  mov R1, R0
  iadd R1, 1
  mov [BP-124], R1
  jmp __for_12507_start
__for_12507_end:
  mov R1, [BP+4]
  iadd R1, 16
  mov R0, [R1]
  ...
  jmp __for_12418_end
__if_12500_end:
__for_12418_continue:
  mov R0, [BP-107]
  mov R1, R0
  iadd R1, 1
  mov [BP-107], R1
  jmp __for_12418_start
__for_12418_end:
  jmp __while_12407_start
__while_12407_end:
__if_12538_start:
  mov R1, [BP+4]
  iadd R1, 16
...
__function_b2GetIdCount:
  ...
  mov R1, [R2]
  isub R0, R1
__function_b2GetIdCount_return:
  pop R2
  pop R1
  mov SP, BP
  pop BP
...
__function_b2GetIdCapacity:
  ...
  iadd R1, 3
  mov R0, [R1]
__function_b2GetIdCapacity_return:
  pop R1
  mov SP, BP
  pop BP
  ret
...
__function_b2CreateCapsuleShape:
  push BP
  mov BP, SP
  isub SP, 7
  mov R1, [BP+2]
...
__if_30698_end:
  ...
  iadd R1, 2
  mov [R1], R0
__function_b2CreateCapsuleShape_return:
  mov SP, BP
  pop BP
  ret
...
__function_b2Body_SetTargetTransform:
  push BP
  mov BP, SP
  isub SP, 15
  mov R1, [BP+2]
...
__if_31490_start:
  ...
  jmp __function_b2Body_SetTargetTransform_return
__if_31490_end:
__if_31496_start:
  mov R1, [BP-1]
  iadd R1, 19
  mov R0, [R1]
  ieq R0, 0
  jf R0, __if_31496_end
  jmp __function_b2Body_SetTargetTransform_return
__if_31496_end:
__if_31502_start:
  mov R0, [BP+5]
  fle R0, 0.000000
  jf R0, __if_31502_end
  jmp __function_b2Body_SetTargetTransform_return
__if_31502_end:
  mov R1, [BP+2]
  mov [SP], R1
  ...
  iadd R1, 2
  mov [R1], R0
__function_b2Body_SetTargetTransform_return:
  mov SP, BP
  pop BP
  ret
...
__if_61514_start:
  mov R2, [BP+2]
  mov [SP], R2
  call __function_b2GetIdCapacity
  mov R1, R0
  mov R3, [BP+2]
  iadd R3, 4
  iadd R3, 1
  ...
  ine R1, R2
  mov R0, R1
  jf R0, __if_61514_end
  mov R0, 1
  jmp __function_b2ValidateWorld_return
__if_61514_end:
__if_61525_start:
  mov R2, [BP+2]
  iadd R2, 29
...
__if_61609_start:
  ...
  mov R0, [R1]
  ieq R0, -1
  jf R0, __if_61609_end
__if_61617_start:
  mov R1, [BP-9]
  iadd R1, 1
  mov R0, [R1]
  ine R0, 0
  jf R0, __if_61617_end
  mov R0, 10
  jmp __function_b2ValidateWorld_return
__if_61617_end:
__if_61625_start:
...
__if_61649_start:
  ...
  mov R0, [R1]
  ine R0, 0
  jf R0, __if_61649_end
  mov R0, 10
  jmp __function_b2ValidateWorld_return
__if_61649_end:
  jmp __for_61591_continue
__if_61609_end:
  mov R0, [BP-5]
  iadd R0, 1
  mov [BP-5], R0
...
__if_61741_start:
  mov R0, [BP-12]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_61746
  mov R1, [BP-12]
  mov R3, [BP+2]
  iadd R3, 4
  iadd R3, 1
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_61746:
  jf R0, __if_61741_end
  mov R0, 20
  jmp __function_b2ValidateWorld_return
__if_61741_end:
  mov R1, [BP+2]
...
__if_61775_start:
  ...
  mov R1, [BP-12]
  ine R0, R1
  jf R0, __if_61775_end
  mov R0, 23
  jmp __function_b2ValidateWorld_return
__if_61775_end:
__for_61717_continue:
  mov R0, [BP-10]
  iadd R0, 1
  mov [BP-10], R0
  jmp __for_61717_start
__for_61717_end:
  mov R0, [BP-2]
  mov R2, [BP-9]
  iadd R2, 6
...
__if_61813_start:
  mov R0, [BP-12]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_61818
  mov R1, [BP-12]
  mov R3, [BP+2]
  iadd R3, 33
  iadd R3, 1
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_61818:
  jf R0, __if_61813_end
  mov R0, 30
  jmp __function_b2ValidateWorld_return
__if_61813_end:
  mov R1, [BP+2]
...
__if_61854_start:
  ...
  mov R0, [R1]
  ine R0, -1
  jf R0, __if_61854_end
  mov R0, 34
  jmp __function_b2ValidateWorld_return
__if_61854_end:
__for_61789_continue:
  mov R0, [BP-10]
  iadd R0, 1
  mov [BP-10], R0
  jmp __for_61789_start
__for_61789_end:
  mov R0, [BP-3]
  mov R2, [BP-9]
  iadd R2, 9
...
__if_61894_start:
  mov R0, [BP-12]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_61899
  mov R1, [BP-12]
  mov R3, [BP+2]
  iadd R3, 40
  iadd R3, 1
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_61899:
  jf R0, __if_61894_end
  mov R0, 40
  jmp __function_b2ValidateWorld_return
__if_61894_end:
  mov R1, [BP+2]
...
__if_61954_start:
  ...
  jmp __function_b2ValidateWorld_return
__if_61954_end:
__for_61870_continue:
  mov R0, [BP-10]
  iadd R0, 1
  mov [BP-10], R0
  jmp __for_61870_start
__for_61870_end:
  mov R0, [BP-4]
  mov R2, [BP-9]
  iadd R2, 12
...
__if_61991_start:
  mov R0, [BP-11]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_61996
  mov R1, [BP-11]
  mov R3, [BP+2]
  iadd R3, 47
  iadd R3, 1
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_61996:
  jf R0, __if_61991_end
  mov R0, 50
  jmp __function_b2ValidateWorld_return
__if_61991_end:
  mov R1, [BP+2]
...
__if_62025_start:
  ...
  mov R1, [BP-11]
  ine R0, R1
  jf R0, __if_62025_end
  mov R0, 53
  jmp __function_b2ValidateWorld_return
__if_62025_end:
__for_61971_continue:
  mov R0, [BP-10]
  iadd R0, 1
  mov [BP-10], R0
  jmp __for_61971_start
__for_61971_end:
__for_61591_continue:
  mov R0, [BP-7]
  iadd R0, 1
  mov [BP-7], R0
  jmp __for_61591_start
__for_61591_end:
__if_62032_start:
  mov R1, [BP-5]
  mov R3, [BP+2]
  iadd R3, 7
  mov [SP], R3
  call __function_b2GetIdCount
  mov R2, R0
  ine R1, R2
  mov R0, R1
  jf R0, __if_62032_end
  mov R0, 60
  jmp __function_b2ValidateWorld_return
__if_62032_end:
__if_62041_start:
...
__if_62109_start:
  ...
  mov R0, [R1]
  ieq R0, -1
  jf R0, __if_62109_end
  jmp __for_62089_continue
__if_62109_end:
__if_62117_start:
  mov R1, [BP-9]
  iadd R1, 17
...
__if_62124_start:
  ...
  mov R0, [R1]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_62131
  mov R2, [BP-9]
  iadd R2, 1
  mov R1, [R2]
  mov R3, [BP+2]
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_62131:
  jf R0, __if_62124_end
  mov R0, 81
  jmp __function_b2ValidateWorld_return
__if_62124_end:
  mov R1, [BP+2]
...
__if_62147_start:
  ...
  mov R0, [R1]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_62154
  mov R2, [BP-9]
  iadd R2, 2
  mov R1, [R2]
  mov R3, [BP-10]
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_62154:
  jf R0, __if_62147_end
  mov R0, 82
  jmp __function_b2ValidateWorld_return
__if_62147_end:
__if_62161_start:
...
__if_62161_end:
  ...
  mov [BP-13], R0
__while_62185_start:
__while_62185_continue:
  mov R0, [BP-13]
  ine R0, -1
  jf R0, __while_62185_end
  mov R0, [BP-13]
  shl R0, -1
  mov [BP-14], R0
  mov R0, [BP-13]
...
__if_62202_start:
  mov R0, [BP-14]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_62207
  mov R1, [BP-14]
  mov R3, [BP+2]
  iadd R3, 33
  iadd R3, 1
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_62207:
  jf R0, __if_62202_end
  mov R0, 84
  jmp __function_b2ValidateWorld_return
__if_62202_end:
  mov R1, [BP+2]
...
__if_62262_start:
  ...
  iadd R1, 1
  igt R0, R1
  jf R0, __if_62262_end
  mov R0, 88
  jmp __function_b2ValidateWorld_return
__if_62262_end:
  jmp __while_62185_start
__while_62185_end:
__if_62272_start:
  mov R0, [BP-11]
  mov R2, [BP-9]
...
__if_62272_end:
  ...
  mov [BP-13], R0
__while_62291_start:
__while_62291_continue:
  mov R0, [BP-13]
  ine R0, -1
  jf R0, __while_62291_end
  mov R0, [BP-13]
  shl R0, -1
  mov [BP-14], R0
  mov R0, [BP-13]
...
__if_62308_start:
  mov R0, [BP-14]
  ilt R0, 0
  jt R0, __LogicalOr_ShortCircuit_62313
  mov R1, [BP-14]
  mov R3, [BP+2]
  iadd R3, 40
  iadd R3, 1
  ...
  ige R1, R2
  or R0, R1
__LogicalOr_ShortCircuit_62313:
  jf R0, __if_62308_end
  mov R0, 89
  jmp __function_b2ValidateWorld_return
__if_62308_end:
  mov R1, [BP+2]
...
__if_62368_start:
  ...
  iadd R1, 1
  igt R0, R1
  jf R0, __if_62368_end
  mov R0, 94
  jmp __function_b2ValidateWorld_return
__if_62368_end:
  jmp __while_62291_start
__while_62291_end:
__if_62378_start:
  mov R0, [BP-11]
  mov R2, [BP-9]
  ...
  mov R1, [R2]
  ine R0, R1
  jf R0, __if_62378_end
  mov R0, 94
  jmp __function_b2ValidateWorld_return
__if_62378_end:
__for_62089_continue:
  mov R0, [BP-8]
  iadd R0, 1
  mov [BP-8], R0
  jmp __for_62089_start
__for_62089_end:
  mov R0, 0
__function_b2ValidateWorld_return:
  iadd SP, 2
  pop R4
  pop R3
  pop R2
...
__for_62465_start:
  ...
  mov R1, [BP+4]
  ilt R0, R1
  jf R0, __for_62465_end
__if_62475_start:
  mov R0, [BP+5]
  ieq R0, 7
  jf R0, __if_62475_end
  mov R1, [BP+2]
  mov [SP], R1
  mov R1, [BP-5]
  mov [SP+1], R1
  call __function_StepJunkyard
__if_62475_end:
  ...
  mov R1, [BP+2]
  mov [SP], R1
  call __function_b2ValidateWorld
  mov [BP-6], R0
__if_62498_start:
  mov R0, [BP-6]
  ine R0, 0
  jf R0, __LogicalAnd_ShortCircuit_62503
  mov R1, [BP-1]
  ieq R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_62503:
  jf R0, __if_62498_end
  mov R0, [BP-6]
  mov [BP-1], R0
__if_62498_end:
  mov R1, [BP+2]
...
__if_62519_start:
  ...
  bnot R1
  mov R0, R1
  jf R0, __if_62519_end
  mov R0, 0
  mov [BP-2], R0
__if_62519_end:
__for_62465_continue:
  mov R0, [BP-5]
  iadd R0, 1
  mov [BP-5], R0
  jmp __for_62465_start
__for_62465_end:
  mov R0, [BP-3]
  mov R1, [BP+4]
  idiv R0, R1
  ...
  mov R1, [R1]
  mov [R1], R0
__function_RunWorld_return:
  mov SP, BP
  pop BP
  ret

__function_BuildLargePyramid:
  push BP
  mov BP, SP
  isub SP, 159
  push R1
...
__for_62671_start:
  ...
  mov CR, 3
  movs
__for_62671_continue:
  mov R0, [BP-151]
  iadd R0, 1
  mov [BP-151], R0
  jmp __for_62671_start
__for_62671_end:
__for_62651_continue:
  mov R0, [BP-150]
  iadd R0, 1
  mov [BP-150], R0
  jmp __for_62651_start
__for_62651_end:
  mov R0, [BP-77]
  mov R1, [BP-77]
  iadd R1, 1
  imul R0, R1
  idiv R0, 2
__function_BuildLargePyramid_return:
  iadd SP, 5
  pop R2
  pop R1
  mov SP, BP
...
__function_BuildTumbler:
  ...
  lea R1, [BP-130]
  mov [SP], R1
  call __function_b2DefaultRevoluteJointDef
  lea R13, [BP-130]
  lea R12, [BP-25]
  mov CR, 3
  movs
  ...
  lea R1, [BP-133]
  mov [SP+2], R1
  call __function_b2CreateRevoluteJointDef
  mov R0, 8
  mov [BP-134], R0
  mov R1, 0.125000
  mov [SP], R1
...
__for_63043_start:
  ...
  fadd R0, 0.400000
  mov [BP-208], R0
__for_63043_continue:
  mov R0, [BP-207]
  iadd R0, 1
  mov [BP-207], R0
  jmp __for_63043_start
__for_63043_end:
  mov R0, [BP-205]
  fadd R0, 0.400000
  mov [BP-205], R0
__for_63027_continue:
  mov R0, [BP-206]
  iadd R0, 1
  mov [BP-206], R0
  jmp __for_63027_start
__for_63027_end:
  mov R0, [BP-134]
  mov R1, [BP-134]
  imul R0, R1
  iadd R0, 1
__function_BuildTumbler_return:
  iadd SP, 5
  pop R1
  mov SP, BP
  pop BP
...
__if_63192_start:
  ...
  isub R1, 3
  ige R0, R1
  jf R0, __LogicalAnd_ShortCircuit_63201
  mov R1, [BP-66]
  mov R2, [BP-1]
  idiv R2, 2
  iadd R2, 3
  ile R1, R2
  and R0, R1
__LogicalAnd_ShortCircuit_63201:
  jf R0, __LogicalAnd_ShortCircuit_63209
  mov R1, [BP-67]
  ieq R1, 0
  and R0, R1
__LogicalAnd_ShortCircuit_63209:
  jf R0, __if_63192_else
  mov R0, 0
  mov [BP-65], R0
  jmp __if_63192_end
__if_63192_else:
...
__if_63301_end:
  ...
  iadd R0, 1
  mov [BP-3], R0
__for_63182_continue:
  mov R0, [BP-67]
  iadd R0, 1
  mov [BP-67], R0
  jmp __for_63182_start
__for_63182_end:
__for_63172_continue:
  mov R0, [BP-66]
  iadd R0, 1
  mov [BP-66], R0
  jmp __for_63172_start
__for_63172_end:
  mov R1, [BP-2]
  mov [SP], R1
  mov R1, [BP-1]
  ...
  mov R1, [BP-1]
  imul R0, R1
__function_BuildJointGrid_return:
  iadd SP, 5
  pop R2
  pop R1
  mov SP, BP
...
__for_63423_start:
  ...
  mov CR, 3
  movs
__for_63423_continue:
  mov R0, [BP-60]
  iadd R0, 1
  mov [BP-60], R0
  jmp __for_63423_start
__for_63423_end:
__for_63401_continue:
  mov R0, [BP-59]
  iadd R0, 1
  mov [BP-59], R0
  jmp __for_63401_start
__for_63401_end:
__function_SmallPyramid_return:
  mov SP, BP
  pop BP
  ret

__function_BuildManyPyramids:
  push BP
  mov BP, SP
  isub SP, 91
  push R1
...
__for_63633_start:
  ...
  mov R1, [BP+3]
  mov [SP+6], R1
  call __function_SmallPyramid
__for_63633_continue:
  mov R0, [BP-48]
  iadd R0, 1
  mov [BP-48], R0
  jmp __for_63633_start
__for_63633_end:
  mov R0, [BP-50]
  mov R1, [BP-42]
  fadd R0, R1
  mov [BP-50], R0
__for_63623_continue:
  mov R0, [BP-47]
  iadd R0, 1
  mov [BP-47], R0
  jmp __for_63623_start
__for_63623_end:
  mov R0, [BP-3]
  mov R1, [BP-4]
  imul R0, R1
  ...
  idiv R1, 2
  imul R0, R1
__function_BuildManyPyramids_return:
  iadd SP, 7
  pop R3
  pop R2
  pop R1
...
__for_63822_start:
  ...
  mov [SP+4], R1
  call __function_b2CreatePolygonShape
__for_63822_continue:
  mov R0, [BP-151]
  iadd R0, 1
  mov [BP-151], R0
  jmp __for_63822_start
__for_63822_end:
__for_63812_continue:
  mov R0, [BP-150]
  iadd R0, 1
  mov [BP-150], R0
  jmp __for_63812_start
__for_63812_end:
  mov R0, [BP-148]
  mov R1, [BP-149]
  imul R0, R1
  iadd R0, 1
__function_BuildSmash_return:
  iadd SP, 5
  pop R1
  mov SP, BP
  pop BP
...
__for_64117_start:
  ...
  mov CR, 3
  movs
__for_64117_continue:
  mov R0, [BP-238]
  iadd R0, 1
  mov [BP-238], R0
  jmp __for_64117_start
__for_64117_end:
__for_64100_continue:
  mov R0, [BP-237]
  iadd R0, 1
  mov [BP-237], R0
  jmp __for_64100_start
__for_64100_end:
  mov R0, [BP-229]
  mov R1, [BP-230]
  imul R0, R1
__function_BuildCompounds_return:
  iadd SP, 5
  pop R2
  pop R1
  mov SP, BP
...
__for_64333_start:
  mov R0, [BP-74]
  ilt R0, 36
  jf R0, __for_64333_end
__if_64345_start:
  mov R0, [BP-74]
  ieq R0, 35
  jf R0, __if_64345_else
  mov R0, 1.000000
  mov [BP-150], R0
  mov R0, 0.000000
  mov [BP-149], R0
...
__if_64446_end:
  ...
  mov CR, 2
  movs
__for_64333_continue:
  mov R0, [BP-74]
  iadd R0, 1
  mov [BP-74], R0
  jmp __for_64333_start
__for_64333_end:
  mov R0, 10
  mov [BP-75], R0
  mov R0, 0.100000
...
__for_64574_start:
  ...
  fadd R0, R1
  mov [BP-149], R0
__for_64574_continue:
  mov R0, [BP-148]
  iadd R0, 1
  mov [BP-148], R0
  jmp __for_64574_start
__for_64574_end:
  mov R0, [BP-147]
  mov R1, [BP-76]
  fmul R1, 2.100000
  fadd R0, R1
  mov [BP-147], R0
__for_64556_continue:
  mov R0, [BP-74]
  iadd R0, 1
  mov [BP-74], R0
  jmp __for_64556_start
__for_64556_end:
  mov R0, [BP-75]
  mov R1, [BP-75]
  imul R0, R1
  iadd R0, 1
__function_BuildWasher_return:
  iadd SP, 5
  pop R2
  pop R1
  mov SP, BP
...
__for_64689_start:
  ...
  fadd R0, R1
  mov [BP-42], R0
__for_64689_continue:
  mov R0, [BP-43]
  iadd R0, 1
  mov [BP-43], R0
  jmp __for_64689_start
__for_64689_end:
  mov R0, [BP-40]
  mov [BP-41], R0
  mov R0, [BP-40]
...
__for_64748_start:
  ...
  fadd R0, R1
  mov [BP-41], R0
__for_64748_continue:
  mov R0, [BP-43]
  iadd R0, 1
  mov [BP-43], R0
  jmp __for_64748_start
__for_64748_end:
  mov R0, [BP-40]
  mov [BP-41], R0
  mov R0, [BP-40]
...
__for_64806_start:
  ...
  fadd R0, R1
  mov [BP-41], R0
__for_64806_continue:
  mov R0, [BP-43]
  iadd R0, 1
  mov [BP-43], R0
  jmp __for_64806_start
__for_64806_end:
  mov R0, 0.250000
  mov [BP-45], R0
  mov R2, 5.000000
...
__for_65050_start:
  ...
  mov CR, 3
  movs
__for_65050_continue:
  mov R0, [BP-44]
  iadd R0, 1
  mov [BP-44], R0
  jmp __for_65050_start
__for_65050_end:
__for_65028_continue:
  mov R0, [BP-43]
  iadd R0, 1
  mov [BP-43], R0
  jmp __for_65028_start
__for_65028_end:
  lea R1, [BP-174]
  mov [SP], R1
  call __function_b2DefaultBodyDef
  ...
  lea R1, [BP-174]
  mov [SP+1], R1
  mov R1, global_g_junkyardPusher
  mov [SP+2], R1
  call __function_b2CreateBody
  mov R0, 0.000000
  mov [BP-176], R0
  ...
  imul R0, R1
  iadd R0, 1
__function_BuildJunkyard_return:
  iadd SP, 5
  pop R3
  pop R2
  pop R1
...
__function_StepJunkyard:
  ...
  mov R1, [BP-1]
  mov [SP+3], R1
  call __function_b2Body_SetTargetTransform
__function_StepJunkyard_return:
  mov SP, BP
  pop BP
  ret

__function_BuildSpinner:
  push BP
  mov BP, SP
  isub SP, 252
  push R1
...
__for_65310_start:
  ...
  mov CR, 2
  movs
__for_65310_continue:
  mov R0, [BP-47]
  iadd R0, 1
  mov [BP-47], R0
  jmp __for_65310_start
__for_65310_end:
  lea R13, [BP-51]
  lea R12, [BP-46]
  mov CR, 2
  ...
  lea R1, [BP-149]
  mov [SP+3], R1
  call __function_b2Body_GetLocalPoint
  mov R0, 1
  mov [BP-137], R0
  mov R0, 5.000000
  mov [BP-136], R0
...
__if_65620_start:
  ...
  lea R1, [BP-248]
  mov [SP+4], R1
  call __function_b2CreateCapsuleShape
  jmp __if_65620_end
__if_65620_else:
__if_65637_start:
  mov R0, [BP-245]
  ieq R0, 1
  jf R0, __if_65637_else
  mov R1, [BP+2]
  mov [SP], R1
  lea R1, [BP-244]
  mov [SP+1], R1
...
__if_65674_start:
  ...
  mov [BP-241], R0
__if_65674_end:
__for_65587_continue:
  mov R0, [BP-47]
  iadd R0, 1
  mov [BP-47], R0
  jmp __for_65587_start
__for_65587_end:
  mov R0, [BP-239]
  iadd R0, 1
__function_BuildSpinner_return:
  iadd SP, 5
  pop R3
  pop R2
  pop R1
...
__if_65881_end:
  ...
  call __function_b2CreateRevoluteJointDef
__if_65819_end:
__function_AddBone_return:
  mov SP, BP
  pop BP
  ret

__function_CreateHuman:
  push BP
  mov BP, SP
  isub SP, 110
  lea R1, [BP-12]
  ...
  mov [SP+22], R1
  call __function_AddBone
__function_CreateHuman_return:
  mov SP, BP
  pop BP
  ret

__function_BuildRain:
  push BP
  mov BP, SP
  isub SP, 81
  push R1
...
__for_66522_start:
  ...
  mov R1, [BP-78]
  mov [SP+7], R1
  call __function_CreateHuman
  lea R13, [BP+3]
  mov R13, [R13]
  mov R12, [BP-78]
  mov CR, 3
  movs
__for_66522_continue:
  mov R0, [BP-79]
  iadd R0, 1
  mov [BP-79], R0
  jmp __for_66522_start
__for_66522_end:
  mov R1, [BP-78]
  mov [SP], R1
  mov R1, 33
...
__if_66630_start:
  mov R0, [BP+7]
  jf R0, __if_66630_else
  mov R1, [global_LX_FIN]
  mov [SP], R1
  mov R1, [BP+2]
  mov [SP+1], R1
  mov R1, __literal_string_66635
  mov [SP+2], R1
  call __function_print_at
  jmp __if_66630_end
__if_66630_else:
...
__if_66640_start:
  mov R0, [BP+6]
  ine R0, 0
  jt R0, __LogicalOr_ShortCircuit_66646
  mov R1, [BP+7]
  bnot R1
  or R0, R1
__LogicalOr_ShortCircuit_66646:
  jf R0, __if_66640_end
  mov R0, 0
  mov [global_g_allPass], R0
__if_66640_end:
__function_DrawRow_return:
  mov SP, BP
  pop BP
  ret
...
__if_66662_start:
  mov R0, [BP+5]
  ieq R0, 0
  jf R0, __if_66662_end
  lea R2, [BP-84]
  mov [SP], R2
  lea R2, [BP-87]
  mov [SP+1], R2
  call __function_BuildLargePyramid
  mov R1, R0
  mov [BP-88], R1
  mov R0, R1
__if_66662_end:
__if_66673_start:
  mov R0, [BP+5]
  ieq R0, 1
  jf R0, __if_66673_end
  lea R2, [BP-84]
  mov [SP], R2
  lea R2, [BP-87]
  mov [SP+1], R2
  call __function_BuildTumbler
  mov R1, R0
  mov [BP-88], R1
  mov R0, R1
__if_66673_end:
__if_66684_start:
  mov R0, [BP+5]
  ieq R0, 2
  jf R0, __if_66684_end
  lea R2, [BP-84]
  mov [SP], R2
  lea R2, [BP-87]
  mov [SP+1], R2
  call __function_BuildJointGrid
  mov R1, R0
  mov [BP-88], R1
  mov R0, R1
__if_66684_end:
__if_66695_start:
  mov R0, [BP+5]
  ieq R0, 3
  jf R0, __if_66695_end
  lea R2, [BP-84]
  mov [SP], R2
  lea R2, [BP-87]
  mov [SP+1], R2
  call __function_BuildManyPyramids
  mov R1, R0
  mov [BP-88], R1
  mov R0, R1
__if_66695_end:
__if_66706_start:
  mov R0, [BP+5]
  ieq R0, 4
  jf R0, __if_66706_end
  lea R2, [BP-84]
  mov [SP], R2
  lea R2, [BP-87]
  mov [SP+1], R2
  call __function_BuildSmash
  mov R1, R0
  mov [BP-88], R1
  mov R0, R1
__if_66706_end:
__if_66717_start:
  mov R0, [BP+5]
  ieq R0, 5
  jf R0, __if_66717_end
  lea R2, [BP-84]
  mov [SP], R2
  lea R2, [BP-87]
  mov [SP+1], R2
  call __function_BuildCompounds
  mov R1, R0
  mov [BP-88], R1
  mov R0, R1
__if_66717_end:
__if_66728_start:
  mov R0, [BP+5]
  ieq R0, 6
  jf R0, __if_66728_end
  lea R2, [BP-84]
  mov [SP], R2
  lea R2, [BP-87]
  mov [SP+1], R2
  call __function_BuildWasher
  mov R1, R0
  mov [BP-88], R1
  mov R0, R1
__if_66728_end:
__if_66739_start:
  mov R0, [BP+5]
  ieq R0, 7
  jf R0, __if_66739_end
  lea R2, [BP-84]
  mov [SP], R2
  lea R2, [BP-87]
  mov [SP+1], R2
  call __function_BuildJunkyard
  mov R1, R0
  mov [BP-88], R1
  mov R0, R1
__if_66739_end:
__if_66750_start:
  mov R0, [BP+5]
  ieq R0, 8
  jf R0, __if_66750_end
  lea R2, [BP-84]
  mov [SP], R2
  lea R2, [BP-87]
  mov [SP+1], R2
  call __function_BuildSpinner
  mov R1, R0
  mov [BP-88], R1
  mov R0, R1
__if_66750_end:
__if_66761_start:
  mov R0, [BP+5]
  ieq R0, 9
  jf R0, __if_66761_end
  lea R2, [BP-84]
  mov [SP], R2
  lea R2, [BP-87]
  mov [SP+1], R2
  call __function_BuildRain
  mov R1, R0
  mov [BP-88], R1
  mov R0, R1
__if_66761_end:
  ...
  mov R1, [BP-91]
  mov [SP+5], R1
  call __function_DrawRow
  call __function_end_frame
__function_Bench_return:
  mov SP, BP
  pop BP
  ret
...
__function_main:
  ...
  mov R1, 78
  mov [SP], R1
  mov R1, __literal_string_66846
  mov [SP+1], R1
  mov R1, [BP-1]
  mov [SP+2], R1
  mov R1, 0
  mov [SP+3], R1
  call __function_Bench
  mov R1, 100
  mov [SP], R1
  mov R1, __literal_string_66851
  mov [SP+1], R1
  mov R1, [BP-1]
  mov [SP+2], R1
  mov R1, 1
  ...
  mov R1, 306
  mov [SP+1], R1
  mov R1, __literal_string_66897
  mov [SP+2], R1
  call __function_print_at
__if_66898_start:
  mov R0, [global_g_allPass]
  jf R0, __if_66898_else
  mov R1, -16711936
  mov [SP], R1
  call __function_set_multiply_color
  mov R1, [global_LX_BODY]
...
__if_66898_else:
  ...
  mov R1, 306
  mov [SP+1], R1
  mov R1, __literal_string_66913
  mov [SP+2], R1
  call __function_print_at
__if_66898_end:
__while_66914_start:
__while_66914_continue:
  mov R0, 1
  jf R0, __while_66914_end
  call __function_end_frame
  jmp __while_66914_start
__while_66914_end:
...
__literal_string_1105:
  string "-2147483648"
__literal_string_66635:
  string "Y"
__literal_string_66639:
  string "N"
__literal_string_66815:
  string "VIRCONBOX2D BENCHMARK   BUDGET/FRAME = 250000 CYC"
__literal_string_66819:
  string "SCENE"
__literal_string_66823:
  string "BODY"
__literal_string_66827:
  string "CYC/STEP"
__literal_string_66831:
  string "PCT"
__literal_string_66835:
  string "VAL"
__literal_string_66839:
  string "F"
__literal_string_66846:
  string "LARGE PYRAMID"
__literal_string_66851:
  string "TUMBLER"
__literal_string_66856:
  string "JOINT GRID"
__literal_string_66861:
  string "MANY PYRAMIDS"
__literal_string_66866:
  string "SMASH"
__literal_string_66871:
  string "COMPOUNDS"
__literal_string_66876:
  string "WASHER"
__literal_string_66881:
  string "JUNKYARD"
__literal_string_66886:
  string "SPINNER"
__literal_string_66891:
  string "RAIN"
__literal_string_66897:
  string "VERDICT"
__literal_string_66906:
  string "ALL SCENES PASS"
__literal_string_66913:
  string "FAIL -- SEE VAL / F COLUMNS"
